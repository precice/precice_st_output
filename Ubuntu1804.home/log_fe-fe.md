...
Job: [1365.20](https://travis-ci.org/precice/systemtests/jobs/629956819) 
...
Step 2/8 : ENV tutorial_path tutorials/HT/partitioned-heat/fenics-fenics
 ---> Running in 9b5f66810026
 ---> b88225a57680
Removing intermediate container 9b5f66810026
Step 3/8 : RUN apk add git
 ---> Running in 47d35fca02ce
...
OK: 22 MiB in 20 packages
 ---> 9cc9cf3bbc20
Removing intermediate container 47d35fca02ce
Step 4/8 : ARG branch=develop
 ---> Running in 110ebcdbf022
 ---> 8b9bad63812c
Removing intermediate container 110ebcdbf022
Step 5/8 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in bdef0d8f5a72
[91mCloning into 'tutorials'...
[0m ---> bf2211ad3b80
Removing intermediate container bdef0d8f5a72
Step 6/8 : RUN mkdir configs && sed -i 's|network="lo"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g' $tutorial_path/[secure]-config.xml
 ---> Running in 4f52169c963f
 ---> 4c5d86796962
Removing intermediate container 4f52169c963f
Step 7/8 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 62ce3b8043fb
 ---> 32002283955f
Removing intermediate container 62ce3b8043fb
Step 8/8 : USER [secure]
 ---> Running in f50e1fdb9d85
 ---> fae01653b99f
Removing intermediate container f50e1fdb9d85

Successfully built fae01653b99f
Successfully tagged testcomposefefeubuntu1804home_tutorial-data:latest
Image for service tutorial-data was built because it did not already exist. To rebuild this image you must use `docker-compose build` or `docker-compose up --build`.
Pulling fenics-adapter-dirichlet ([secure]/fenics-adapter-ubuntu1804.home-develop:latest)...
latest: Pulling from [secure]/fenics-adapter-ubuntu1804.home-develop
Digest: sha256:fc5836fc8d1eef591a0cf22254b8974d771719b4b01b280d8b9f85b755af9c72
...
travis_time:end:00a28355:start=1577445970060607829,finish=1577446084055459585,duration=113994851756,event=script[0K[31;1mThe command "python system_testing.py -s fe-fe --base Ubuntu1804.home" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:038b391a[0K$ python push.py -t fe-fe --base Ubuntu1804.home

```
[
Full job log](https://api.travis-ci.org/v3/job/629956819/log.txt)