...
Job: [1354.20](https://travis-ci.org/precice/systemtests/jobs/627653318) 
...
Step 2/8 : ENV tutorial_path tutorials/HT/partitioned-heat/fenics-fenics
 ---> Running in 501c5260c373
 ---> 15da0d73b701
Removing intermediate container 501c5260c373
Step 3/8 : RUN apk add git
 ---> Running in 456f7a48be69
...
OK: 22 MiB in 20 packages
 ---> 70f8b6a4c537
Removing intermediate container 456f7a48be69
Step 4/8 : ARG branch=develop
 ---> Running in 5d4d989733bb
 ---> 8f62ae838e63
Removing intermediate container 5d4d989733bb
Step 5/8 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in c5bb0d5072cd
[91mCloning into 'tutorials'...
[0m ---> 7996fe71a7f3
Removing intermediate container c5bb0d5072cd
Step 6/8 : RUN mkdir configs && sed -i 's|network="lo"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g' $tutorial_path/[secure]-config.xml
 ---> Running in e827f3facbaa
 ---> 0fcd5e6ba967
Removing intermediate container e827f3facbaa
Step 7/8 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in cc920d83f090
 ---> d584f7c04c65
Removing intermediate container cc920d83f090
Step 8/8 : USER [secure]
 ---> Running in 15e0eb71fe10
 ---> e927014141b9
Removing intermediate container 15e0eb71fe10

Successfully built e927014141b9
Successfully tagged testcomposefefeubuntu1804home_tutorial-data:latest
Image for service tutorial-data was built because it did not already exist. To rebuild this image you must use `docker-compose build` or `docker-compose up --build`.
Pulling fenics-adapter-dirichlet ([secure]/fenics-adapter-ubuntu1804.home-develop:latest)...
latest: Pulling from [secure]/fenics-adapter-ubuntu1804.home-develop
Digest: sha256:a40fa1295b69cca0cccf019b4aaa892039b9e8e7ca3fe03ac685b3129711dc6a
...
travis_time:end:18c88257:start=1576841109966170547,finish=1576841224441244996,duration=114475074449,event=script[0K[31;1mThe command "python system_testing.py -s fe-fe --base Ubuntu1804.home" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:16b2605e[0K$ python push.py -t fe-fe --base Ubuntu1804.home
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/627653318/log.txt)