...
Step 2/8 : ENV tutorial_path tutorials/HT/partitioned-heat/fenics-fenics
 ---> Running in 894bbdbca20c
 ---> 845ebd772212
Removing intermediate container 894bbdbca20c
Step 3/8 : RUN apk add git
 ---> Running in 4b8643a55fe6
...
OK: 21 MiB in 20 packages
 ---> 1116aa14efc1
Removing intermediate container 4b8643a55fe6
Step 4/8 : ARG branch=develop
 ---> Running in 92196745dd91
 ---> f75012d2d729
Removing intermediate container 92196745dd91
Step 5/8 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in a08d9ff77fb6
[91mCloning into 'tutorials'...
[0m ---> 4b609eb8b2ed
Removing intermediate container a08d9ff77fb6
Step 6/8 : RUN mkdir configs && sed -i 's|network="lo"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g' $tutorial_path/[secure]-config.xml
 ---> Running in 01a50a3b6b5b
 ---> 598c3531c99f
Removing intermediate container 01a50a3b6b5b
Step 7/8 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 831c937566b7
 ---> 0d2c3ddad116
Removing intermediate container 831c937566b7
Step 8/8 : USER [secure]
 ---> Running in 4584ad202df0
 ---> 784a17e8087f
Removing intermediate container 4584ad202df0

Successfully built 784a17e8087f
