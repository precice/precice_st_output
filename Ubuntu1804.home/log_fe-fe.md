## Status: Failure 
Build: [1259](https://travis-ci.org/precice/systemtests/builds/620625764) 

Job: [1259.16](https://travis-ci.org/precice/systemtests/jobs/620625780) 

Triggered by: [pull_request](https://github.com/precice/systemtests/pull/133) 
...
Step 2/8 : ENV tutorial_path tutorials/HT/partitioned-heat/fenics-fenics
 ---> Running in ada96cb2eda8
 ---> 2f0bb1910213
Removing intermediate container ada96cb2eda8
Step 3/8 : RUN apk add git
 ---> Running in 8d1108d994ce
...
OK: 21 MiB in 20 packages
 ---> 20ca95ea265f
Removing intermediate container 8d1108d994ce
Step 4/8 : ARG branch=develop
 ---> Running in d1df00432ca3
 ---> 040043e74d7b
Removing intermediate container d1df00432ca3
Step 5/8 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 70e477903273
[91mCloning into 'tutorials'...
[0m ---> b854f040082f
Removing intermediate container 70e477903273
Step 6/8 : RUN mkdir configs && sed -i 's|network="lo"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g' $tutorial_path/[secure]-config.xml
 ---> Running in ccc0eb265776
 ---> c6f9ddebffcc
Removing intermediate container ccc0eb265776
Step 7/8 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in f62f81053866
 ---> 74c038aed158
Removing intermediate container f62f81053866
Step 8/8 : USER [secure]
 ---> Running in b78b07c690b6
 ---> 0aeb0ded68c7
Removing intermediate container b78b07c690b6

Successfully built 0aeb0ded68c7
Successfully tagged testcomposefefeubuntu1804home_tutorial-data:latest
Image for service tutorial-data was built because it did not already exist. To rebuild this image you must use `docker-compose build` or `docker-compose up --build`.
Pulling fenics-adapter-dirichlet ([secure]/fenics-adapter-ubuntu1804.home-develop:latest)...
latest: Pulling from [secure]/fenics-adapter-ubuntu1804.home-develop
Digest: sha256:e6399dfe1966ca7be2eb2a0eabcc69d43dab4b52fcf868e012912f4866d5de04
...
[36mfenics-adapter-dirichlet    |[0m ---[[secure]] [0m Revision info: v1.6.1-139-g0fd27c29
...
travis_time:end:00db5070:start=1575472525460710991,finish=1575473207084178009,duration=681623467018,event=script[0K[31;1mThe command "python system_testing.py -s fe-fe --base Ubuntu1804.home" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:026daaae[0K$ python push.py -t fe-fe --base Ubuntu1804.home
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/620625780/log.txt)