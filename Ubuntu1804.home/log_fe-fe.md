...
Job: [1413.4](https://travis-ci.org/precice/systemtests/jobs/634661132) 
...
Step 2/8 : ENV tutorial_path tutorials/HT/partitioned-heat/fenics-fenics
 ---> Running in bb0e30f8f35a
 ---> 6d18c02c00be
Removing intermediate container bb0e30f8f35a
Step 3/8 : RUN apk add git
 ---> Running in e662d8ca6f59
...
OK: 22 MiB in 20 packages
 ---> 8997bf068c38
Removing intermediate container e662d8ca6f59
Step 4/8 : ARG branch=develop
 ---> Running in fed63f570e3e
 ---> 96c74288695f
Removing intermediate container fed63f570e3e
Step 5/8 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 5959e709b2a7
[91mCloning into 'tutorials'...
[0m ---> 954bce94256c
Removing intermediate container 5959e709b2a7
Step 6/8 : RUN mkdir configs && sed -i 's|network="lo"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g' $tutorial_path/[secure]-config.xml
 ---> Running in 5d6f953fb95f
 ---> a6e8e01d29b0
Removing intermediate container 5d6f953fb95f
Step 7/8 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 3bd03e7e382e
 ---> a1e74ab55605
Removing intermediate container 3bd03e7e382e
Step 8/8 : USER [secure]
 ---> Running in e0d60bfe4232
 ---> e6e6149e8941
Removing intermediate container e0d60bfe4232

Successfully built e6e6149e8941
...
travis_time:end:19fc63a4:start=1578563596667628453,finish=1578563650984460771,duration=54316832318,event=script[0K[31;1mThe command "python system_testing.py -s fe-fe --base Ubuntu1804.home" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:03e998c0[0K$ python push.py -t fe-fe --base Ubuntu1804.home
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/634661132/log.txt)