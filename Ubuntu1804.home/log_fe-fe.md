 # Status :  Passing 
 # [Job url](https://travis-ci.org/precice/systemtests/builds/585365184) 
## Triggered by: [cron](https://github.com/precice/systemtests/compare/54b96c7718c6c434cfc8b2262d3057a82de97903...51ea4812093d2ae31257f4fbeb796550d815c6ef) 
...
Step 2/7 : ENV tutorial_path tutorials/HT/partitioned-heat/fenics-fenics
 ---> Running in d274123601a2
 ---> 586a7c22e4e1
Removing intermediate container d274123601a2
Step 3/7 : RUN apk add git
 ---> Running in ad83293687ea
...
OK: 21 MiB in 20 packages
 ---> dca7b259e6df
Removing intermediate container ad83293687ea
Step 4/7 : RUN git clone https://github.com/[secure]/tutorials
 ---> Running in e793c7a92d06
[91mCloning into 'tutorials'...
[0m ---> 303a88ff4dbf
Removing intermediate container e793c7a92d06
Step 5/7 : RUN mkdir configs && sed -i 's|network="lo"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g' $tutorial_path/[secure]-config.xml
 ---> Running in 395824f447b7
 ---> b1b81610d07c
Removing intermediate container 395824f447b7
Step 6/7 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 20609d316a07
 ---> f8bbdc313f98
Removing intermediate container 20609d316a07
Step 7/7 : USER [secure]
 ---> Running in 2c8cc9927f8d
 ---> b215c2505624
Removing intermediate container 2c8cc9927f8d

Successfully built b215c2505624
...
[1A[2KCreating fenics-adapter-neumann ... [32mdone[0m[1B[1A[2KCreating fenics-adapter-dirichlet ... [32mdone[0m[1BRunning the simulation...Be patient
 ```
[Full job log](https://api.travis-ci.org/v3/job/585365204/log.txt)