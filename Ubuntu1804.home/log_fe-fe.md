...
Job: [1047.20](https://travis-ci.org/precice/systemtests/jobs/604758649) 
...
Step 2/7 : ENV tutorial_path tutorials/HT/partitioned-heat/fenics-fenics
 ---> Running in 205e6891275a
 ---> 0886a5b1fb6d
Removing intermediate container 205e6891275a
Step 3/7 : RUN apk add git
 ---> Running in 24771d339261
...
OK: 21 MiB in 20 packages
 ---> 329df69a63f5
Removing intermediate container 24771d339261
Step 4/7 : RUN git clone https://github.com/[secure]/tutorials
 ---> Running in be8c05e0e6ad
[91mCloning into 'tutorials'...
[0m ---> 251746c698dc
Removing intermediate container be8c05e0e6ad
Step 5/7 : RUN mkdir configs && sed -i 's|network="lo"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g' $tutorial_path/[secure]-config.xml
 ---> Running in 00f55d294d09
 ---> e715bed2658c
Removing intermediate container 00f55d294d09
Step 6/7 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 9c362b676d8e
 ---> 0420b3293467
Removing intermediate container 9c362b676d8e
Step 7/7 : USER [secure]
 ---> Running in 3c5ad288064d
 ---> 0f8465f7d87e
Removing intermediate container 3c5ad288064d

Successfully built 0f8465f7d87e
Successfully tagged testcomposefefeubuntu1804home_tutorial-data:latest
Image for service tutorial-data was built because it did not already exist. To rebuild this image you must use `docker-compose build` or `docker-compose up --build`.
Pulling fenics-adapter-dirichlet ([secure]/fenics-adapter-ubuntu1804.home-develop:latest)...
latest: Pulling from [secure]/fenics-adapter-ubuntu1804.home-develop
Digest: sha256:49e627a5411fdef4c2de6685332623910ec61b14b9c0e0af119a78a518741c79
...
travis_time:end:17a5b843:start=1572403215788947757,finish=1572403342439253271,duration=126650305514,event=script[0K[32;1mThe command "python system_testing.py -s fe-fe --base Ubuntu1804.home" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:067be6ac
```
[
Full job log](https://api.travis-ci.org/v3/job/604758649/log.txt)