...
Job: [1425.4](https://travis-ci.org/precice/systemtests/jobs/635309607) 
...
Step 2/8 : ENV tutorial_path tutorials/HT/partitioned-heat/fenics-fenics
 ---> Running in 62eb25df2a60
 ---> e7429647b835
Removing intermediate container 62eb25df2a60
Step 3/8 : RUN apk add git
 ---> Running in 9e201e917974
...
OK: 22 MiB in 20 packages
 ---> 72ac376333e2
Removing intermediate container 9e201e917974
Step 4/8 : ARG branch=develop
 ---> Running in f90315a3b1f0
 ---> c0426a09a513
Removing intermediate container f90315a3b1f0
Step 5/8 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in f6b532332146
[91mCloning into 'tutorials'...
[0m ---> e227154dca18
Removing intermediate container f6b532332146
Step 6/8 : RUN mkdir configs && sed -i 's|<m2n:sockets from="HeatDirichlet" to="HeatNeumann"/>|<m2n:sockets from="HeatDirichlet" to="HeatNeumann" exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"/>|g' $tutorial_path/[secure]-config.xml
 ---> Running in 6d9c2e4412fd
 ---> 5adcd80106b8
Removing intermediate container 6d9c2e4412fd
Step 7/8 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 1f00fadb4e58
 ---> 768c3c816382
Removing intermediate container 1f00fadb4e58
Step 8/8 : USER [secure]
 ---> Running in 85ea91296e2a
 ---> 87d4b157a904
Removing intermediate container 85ea91296e2a

Successfully built 87d4b157a904
...
[32mfenics-adapter-dirichlet exited with code 255
[0m[33mfenics-adapter-neumann exited with code 255
...
travis_time:end:0651f283:start=1578670570226498575,finish=1578670637423883722,duration=67197385147,event=script[0K[31;1mThe command "python system_testing.py -s fe-fe --base Ubuntu1804.home" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:0afef291[0K$ python push.py -t fe-fe --base Ubuntu1804.home
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/635309607/log.txt)