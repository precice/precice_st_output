...
Job: [1419.21](https://travis-ci.org/precice/systemtests/jobs/635195390) 
...
Step 2/8 : ENV tutorial_path tutorials/HT/partitioned-heat/fenics-fenics
 ---> Running in 5eb9f36f8e9f
 ---> de1c7839c6e9
Removing intermediate container 5eb9f36f8e9f
Step 3/8 : RUN apk add git
 ---> Running in 531c3fd6f882
...
OK: 22 MiB in 20 packages
 ---> ca1e79737fff
Removing intermediate container 531c3fd6f882
Step 4/8 : ARG branch=develop
 ---> Running in ee373a9ba857
 ---> 9035c7e14296
Removing intermediate container ee373a9ba857
Step 5/8 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in fdda8794fa7f
[91mCloning into 'tutorials'...
[0m ---> 697749cb7299
Removing intermediate container fdda8794fa7f
Step 6/8 : RUN mkdir configs && sed -i 's|network="lo"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g' $tutorial_path/[secure]-config.xml
 ---> Running in f006d6bc3578
 ---> ec8d52645c01
Removing intermediate container f006d6bc3578
Step 7/8 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 19f5e1d53d26
 ---> c1b30c5b01de
Removing intermediate container 19f5e1d53d26
Step 8/8 : USER [secure]
 ---> Running in 9d054266e356
 ---> 46bd14529c10
Removing intermediate container 9d054266e356

Successfully built 46bd14529c10
...
travis_time:end:075e0c35:start=1578655964426864584,finish=1578656078795394604,duration=114368530020,event=script[0K[31;1mThe command "python system_testing.py -s fe-fe --base Ubuntu1804.home" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:115bd3d1[0K$ python push.py -t fe-fe --base Ubuntu1804.home
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/635195390/log.txt)