...
Step 2/9 : ENV tutorial_path tutorials/FSI/flap_perp/SU2-CalculiX
 ---> Running in ea6b6fdabd78
 ---> 5866e905b5d0
Removing intermediate container ea6b6fdabd78
Step 3/9 : RUN apk add git bash
 ---> Running in de0cd78f1417
...
OK: 30 MiB in 25 packages
 ---> 3c40a3ceeece
Removing intermediate container de0cd78f1417
Step 4/9 : RUN git clone https://github.com/[secure]/tutorials
 ---> Running in 995dd43a2707
[91mCloning into 'tutorials'...
[0m ---> a5bf27f2c6ea
Removing intermediate container 995dd43a2707
Step 5/9 : RUN mkdir configs && sed -e 's|exchange-directory="../"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g'    $tutorial_path/[secure]-config_serial.xml  > configs/[secure]-config.xml
 ---> Running in 9e93074d3736
 ---> 2188b674945b
Removing intermediate container 9e93074d3736
Step 6/9 : RUN rm $tutorial_path/[secure]-config_serial.xml $tutorial_path/[secure]-config.xml
 ---> Running in 8c33daaa1696
 ---> 02b4e6b30090
Removing intermediate container 8c33daaa1696
Step 7/9 : RUN cp $tutorial_path/config.yml configs/
 ---> Running in 1c1f1be0ee9c
 ---> 7edafc6ab7a4
Removing intermediate container 1c1f1be0ee9c
Step 8/9 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 57d7e73cf620
 ---> 2415a2d4bea6
Removing intermediate container 57d7e73cf620
Step 9/9 : USER [secure]
 ---> Running in 7756ec0e2511
 ---> bf7da56afcee
Removing intermediate container 7756ec0e2511
Successfully built bf7da56afcee
...
Digest: sha256:92b6505b91c110b8d90b5544b4caf78a0181dd7f0c3c5c468662d845d0bc21a0
...
travis_time:end:15285f1f:start=1571394146130168288,finish=1571394503108135776,duration=356977967488,event=script[0K[32;1mThe command "python system_testing.py -s su2-ccx" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:0a29f89e[0K$ python push.py -s -t su2-ccx
Cloning into '[secure]_st_output'...
 ```
[Full job log](https://api.travis-ci.org/v3/job/599535299/log.txt)