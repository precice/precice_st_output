...
Step 2/9 : ENV tutorial_path tutorials/FSI/flap_perp/SU2-CalculiX
 ---> Running in 4082f879c18b
 ---> 59009b7bbf14
Removing intermediate container 4082f879c18b
Step 3/9 : RUN apk add git bash
 ---> Running in 708e2db7ffa8
...
OK: 30 MiB in 25 packages
 ---> 0f501875a5bd
Removing intermediate container 708e2db7ffa8
Step 4/9 : RUN git clone https://github.com/[secure]/tutorials
 ---> Running in a9a224272c72
[91mCloning into 'tutorials'...
[0m ---> 5da056e8f42f
Removing intermediate container a9a224272c72
Step 5/9 : RUN mkdir configs && sed -e 's|exchange-directory="../"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g'    $tutorial_path/[secure]-config_serial.xml  > configs/[secure]-config.xml
 ---> Running in 87e76fded0f9
 ---> c4d836548d46
Removing intermediate container 87e76fded0f9
Step 6/9 : RUN rm $tutorial_path/[secure]-config_serial.xml $tutorial_path/[secure]-config.xml
 ---> Running in 6a37d5b98625
 ---> 79c07d1c17b0
Removing intermediate container 6a37d5b98625
Step 7/9 : RUN cp $tutorial_path/config.yml configs/
 ---> Running in 50fcfe3c8070
 ---> 586c57fb4bdc
Removing intermediate container 50fcfe3c8070
Step 8/9 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 2ef04bff8ebe
 ---> 3f5151a99c09
Removing intermediate container 2ef04bff8ebe
Step 9/9 : USER [secure]
 ---> Running in f565b99cb5f4
 ---> 083905f8c8b5
Removing intermediate container f565b99cb5f4
Successfully built 083905f8c8b5
...
Digest: sha256:75ead98c7228a64309f0a7fe76d5b178c116a6211144b6df1247a1c62fe7c157
...
travis_time:end:17efa374:start=1570203788488743400,finish=1570204077769640877,duration=289280897477,event=script[0K[32;1mThe command "python system_testing.py -s su2-ccx" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:23404bac[0K$ python push.py -s -t su2-ccx
Cloning into '[secure]_st_output'...
 ```
[Full job log](https://api.travis-ci.org/v3/job/593511832/log.txt)