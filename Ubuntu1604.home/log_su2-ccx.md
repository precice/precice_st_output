...
Job: [1519.14](https://travis-ci.org/precice/systemtests/jobs/641972705) 
...
Step 2/10 : ENV tutorial_path tutorials/FSI/flap_perp/SU2-CalculiX
 ---> Running in f9e91726582e
 ---> fefd635eaebd
Removing intermediate container f9e91726582e
Step 3/10 : RUN apk add git bash
 ---> Running in 109b768c8a1c
...
OK: 31 MiB in 25 packages
 ---> d463acd87a53
Removing intermediate container 109b768c8a1c
Step 4/10 : ARG branch=develop
 ---> Running in 5170500bb526
 ---> 0a2041304856
Removing intermediate container 5170500bb526
Step 5/10 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in ac2464190574
...
travis_time:end:036c90b4:start=1580036962511395573,finish=1580036973015586000,duration=10504190427,event=script[0K[31;1mThe command "python system_testing.py -s su2-ccx" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:09aa1ad9[0K$ python push.py -t su2-ccx
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/641972705/log.txt)