...
Job: [1155.17](https://travis-ci.org/precice/systemtests/jobs/617504397) 
...
Step 2/9 : ENV tutorial_path tutorials/FSI/flap_perp/SU2-CalculiX
 ---> Running in 972031e9e993
 ---> 5f623853d231
Removing intermediate container 972031e9e993
Step 3/9 : RUN apk add git bash
 ---> Running in 20d78f0c514f
...
OK: 30 MiB in 25 packages
 ---> 29d04a2cfb1f
Removing intermediate container 20d78f0c514f
Step 4/9 : RUN git clone https://github.com/[secure]/tutorials
 ---> Running in c182de17de83
[91mCloning into 'tutorials'...
[0m ---> 4e56da5c9007
Removing intermediate container c182de17de83
Step 5/9 : RUN mkdir configs && sed -e 's|exchange-directory="../"|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g'    $tutorial_path/[secure]-config_serial.xml  > configs/[secure]-config.xml
 ---> Running in 264a7383ee8f
 ---> 3a3e248e8d24
Removing intermediate container 264a7383ee8f
Step 6/9 : RUN rm $tutorial_path/[secure]-config_serial.xml $tutorial_path/[secure]-config.xml
 ---> Running in ee60803ff7be
 ---> 4e35408a2096
Removing intermediate container ee60803ff7be
Step 7/9 : RUN cp $tutorial_path/config.yml configs/
 ---> Running in e58fb1cead02
 ---> feecebb42817
Removing intermediate container e58fb1cead02
Step 8/9 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 62dde210220f
 ---> aa219ff9c6bc
Removing intermediate container 62dde210220f
Step 9/9 : USER [secure]
 ---> Running in 3b49608a6ac0
 ---> dc43fd5978e1
Removing intermediate container 3b49608a6ac0
Successfully built dc43fd5978e1
...
Digest: sha256:9dd0e110f44752d7b4f4512abd7e4f12b3b88136b1f7de4d3ea2e52350d0dcdf
...
travis_time:end:18d706f8:start=1574823190042684362,finish=1574823479256134845,duration=289213450483,event=script[0K[32;1mThe command "python system_testing.py -s su2-ccx" exited with 0.[0m
...
```
[
Full job log](https://api.travis-ci.org/v3/job/617504397/log.txt)