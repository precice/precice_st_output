...
Job: [1434.18](https://travis-ci.org/precice/systemtests/jobs/635635637) 
...
Step 2/10 : ENV tutorial_path tutorials/FSI/flap_perp/SU2-CalculiX
 ---> Running in b9d0ff93aa42
 ---> f09c7f930a34
Removing intermediate container b9d0ff93aa42
Step 3/10 : RUN apk add git bash
 ---> Running in 85a5368bd359
...
OK: 31 MiB in 25 packages
 ---> 70eb6b5932e6
Removing intermediate container 85a5368bd359
Step 4/10 : ARG branch=develop
 ---> Running in 81590e6b515b
 ---> bffc1eeb8a10
Removing intermediate container 81590e6b515b
Step 5/10 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 17c48463b99a
[91mCloning into 'tutorials'...
[0m ---> daa8f18a8a9e
Removing intermediate container 17c48463b99a
...
travis_time:end:00233352:start=1578742272826907065,finish=1578742283385807911,duration=10558900846,event=script[0K[31;1mThe command "python system_testing.py -s su2-ccx" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:027bec28[0K$ python push.py -t su2-ccx
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/635635637/log.txt)