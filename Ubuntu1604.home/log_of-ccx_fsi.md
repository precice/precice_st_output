...
Job: [1587.25](https://travis-ci.org/precice/systemtests/jobs/645394824) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in eb2dd68648c6
 ---> ca4f26b5ada4
Removing intermediate container eb2dd68648c6
Step 3/12 : RUN apk add git bash
 ---> Running in d6c6d37bdcb9
...
OK: 31 MiB in 25 packages
 ---> fd4224135ed9
Removing intermediate container d6c6d37bdcb9
Step 4/12 : ARG branch=develop
 ---> Running in 673e8c80dc15
 ---> 648eb18d84bd
Removing intermediate container 673e8c80dc15
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in a88868f59c80
[91mCloning into 'tutorials'...
[0m ---> ad196bee7403
Removing intermediate container a88868f59c80
Step 6/12 : WORKDIR /
 ---> 30f699752eff
Removing intermediate container 33cbbba8aa41
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> b488fee4b372
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in caf55a9dc99c
 ---> 1a37529f611f
Removing intermediate container caf55a9dc99c
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in 8ea241c82a81
 ---> 7d4cd094b150
Removing intermediate container 8ea241c82a81
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in ee2be52b3792
 ---> 615eee712a5f
Removing intermediate container ee2be52b3792
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in e2c337d33268
 ---> 14a7b6692de9
Removing intermediate container e2c337d33268
Step 12/12 : USER [secure]
 ---> Running in 4d75e2acfc85
 ---> ae5a67e9a6ec
Removing intermediate container 4d75e2acfc85
Successfully built ae5a67e9a6ec
...
travis_time:end:180d4400:start=1580730530642938971,finish=1580730608585043227,duration=77942104256,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:02d5c900[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/645394824/log.txt)