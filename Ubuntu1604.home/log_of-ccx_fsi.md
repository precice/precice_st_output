...
Job: [1574.25](https://travis-ci.org/precice/systemtests/jobs/644725362) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 946d8c42f5ac
 ---> b160e07ed9c6
Removing intermediate container 946d8c42f5ac
Step 3/12 : RUN apk add git bash
 ---> Running in 349f6ec66468
...
OK: 31 MiB in 25 packages
 ---> 4fa27e2a3144
Removing intermediate container 349f6ec66468
Step 4/12 : ARG branch=develop
 ---> Running in 3b9085e28379
 ---> 122d1bef7fc9
Removing intermediate container 3b9085e28379
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in e4f2d916fe09
[91mCloning into 'tutorials'...
[0m ---> 6506d9c1fc5c
Removing intermediate container e4f2d916fe09
Step 6/12 : WORKDIR /
 ---> cd798c419f99
Removing intermediate container dc13669195d4
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> cb1c9091ddea
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in f34807ef7f9c
 ---> f9b4d5e6d4b0
Removing intermediate container f34807ef7f9c
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in de78fc870ba2
 ---> da4368322dd0
Removing intermediate container de78fc870ba2
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in 94e9e007932d
 ---> c0969b76a06b
Removing intermediate container 94e9e007932d
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 9a54a0cced1a
 ---> 11ec3298b2e3
Removing intermediate container 9a54a0cced1a
Step 12/12 : USER [secure]
 ---> Running in b5d8ce8bbf38
 ---> 3bebd29a4c94
Removing intermediate container b5d8ce8bbf38
Successfully built 3bebd29a4c94
...
travis_time:end:06434436:start=1580557925019194824,finish=1580558002317372064,duration=77298177240,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:05fc4db0[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/644725362/log.txt)