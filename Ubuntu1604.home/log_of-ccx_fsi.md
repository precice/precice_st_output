...
Job: [1481.22](https://travis-ci.org/precice/systemtests/jobs/640895703) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 07519d607884
 ---> 5cb13d2cf287
Removing intermediate container 07519d607884
Step 3/12 : RUN apk add git bash
 ---> Running in b6b30912418d
...
OK: 31 MiB in 25 packages
 ---> 604342c37c8f
Removing intermediate container b6b30912418d
Step 4/12 : ARG branch=develop
 ---> Running in e27ac931e3ea
 ---> cc5f7610e7eb
Removing intermediate container e27ac931e3ea
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 51773039198f
[91mCloning into 'tutorials'...
[0m ---> df00260fb27b
Removing intermediate container 51773039198f
Step 6/12 : WORKDIR /
 ---> 21a6cb5b64e7
Removing intermediate container 0a561e0e467c
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> fc703276379d
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 21102f830580
 ---> c12307a97453
Removing intermediate container 21102f830580
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in 8a73cb826227
 ---> ae5024fe79f1
Removing intermediate container 8a73cb826227
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in 10e1c86533d8
 ---> 2c681abeafd2
Removing intermediate container 10e1c86533d8
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 28e88dc49f74
 ---> bfecaa54dca1
Removing intermediate container 28e88dc49f74
Step 12/12 : USER [secure]
 ---> Running in 4c1d76de469a
 ---> bb353b1817fe
Removing intermediate container 4c1d76de469a
Successfully built bb353b1817fe
...
travis_time:end:0e0e1f10:start=1579788725876254358,finish=1579788801936012484,duration=76059758126,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:06161808[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/640895703/log.txt)