...
Job: [1584.22](https://travis-ci.org/precice/systemtests/jobs/645200415) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in dd3cab3c3f61
 ---> 58a4273a4b3d
Removing intermediate container dd3cab3c3f61
Step 3/12 : RUN apk add git bash
 ---> Running in 582a06fb1ec8
...
OK: 31 MiB in 25 packages
 ---> 0de3615ca6fc
Removing intermediate container 582a06fb1ec8
Step 4/12 : ARG branch=develop
 ---> Running in 0002ebae4fbf
 ---> 6eb338b18b2a
Removing intermediate container 0002ebae4fbf
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 8799a937e850
[91mCloning into 'tutorials'...
[0m ---> eb1507656e5f
Removing intermediate container 8799a937e850
Step 6/12 : WORKDIR /
 ---> 32b67094e662
Removing intermediate container a82a81de673e
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> 2f74f9ecd858
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in c341ab0c9f59
 ---> aba4548b0739
Removing intermediate container c341ab0c9f59
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in 378ff1c2a3dc
 ---> 46939726b237
Removing intermediate container 378ff1c2a3dc
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in fb4f8a59f84b
 ---> 42711b86a534
Removing intermediate container fb4f8a59f84b
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 1ab5fec021fb
 ---> d4b522045ae8
Removing intermediate container 1ab5fec021fb
Step 12/12 : USER [secure]
 ---> Running in 4be897931be7
 ---> deac1292329b
Removing intermediate container 4be897931be7
Successfully built deac1292329b
...
EXECUTING: bash ../../compare_results.sh /home
```
[
Full job log](https://api.travis-ci.org/v3/job/645200415/log.txt)