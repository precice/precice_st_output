...
Job: [1475.26](https://travis-ci.org/precice/systemtests/jobs/640388658) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 8e89da7a42b4
 ---> 6ddd623cfa10
Removing intermediate container 8e89da7a42b4
Step 3/12 : RUN apk add git bash
 ---> Running in 169fa9bba77f
...
OK: 31 MiB in 25 packages
 ---> 3cf4fcdedfcb
Removing intermediate container 169fa9bba77f
Step 4/12 : ARG branch=develop
 ---> Running in e15ba57215d1
 ---> a5dcdbffb13a
Removing intermediate container e15ba57215d1
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in fee3313f61c0
[91mCloning into 'tutorials'...
[0m ---> 5370ab9b1cae
Removing intermediate container fee3313f61c0
Step 6/12 : WORKDIR /
 ---> 3d4b3bfc750b
Removing intermediate container 77e39c10e16c
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> 76371af92180
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 11ed95fb691f
 ---> caaccd08252e
Removing intermediate container 11ed95fb691f
...
travis_time:end:09424c7a:start=1579694599529611961,finish=1579694611597115133,duration=12067503172,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:27d734c9[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/640388658/log.txt)