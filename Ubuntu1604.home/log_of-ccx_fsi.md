## Status: Failure 
Build: [1477](https://travis-ci.org/precice/systemtests/builds/640854832) 

Job: [1477.9](https://travis-ci.org/precice/systemtests/jobs/640854847) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 1633adbefa2d
 ---> c727b9da6554
Removing intermediate container 1633adbefa2d
Step 3/12 : RUN apk add git bash
 ---> Running in fcf88429de4b
...
OK: 31 MiB in 25 packages
 ---> 0c2b8d49e632
Removing intermediate container fcf88429de4b
Step 4/12 : ARG branch=develop
 ---> Running in 13eca1c08a87
 ---> 0f28f9fd5a96
Removing intermediate container 13eca1c08a87
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 324ce18c78fa
[91mCloning into 'tutorials'...
[0m ---> eeca26a3c027
Removing intermediate container 324ce18c78fa
Step 6/12 : WORKDIR /
 ---> 1b1cd71f0b96
Removing intermediate container dc70c33b62c0
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> 023996a9241c
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in cfe731145a03
 ---> 21b59d8b9a20
Removing intermediate container cfe731145a03
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in 3ca6a035f53d
 ---> 563848584ddf
Removing intermediate container 3ca6a035f53d
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in 4f655726ac6f
 ---> 9f5757fe1283
Removing intermediate container 4f655726ac6f
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in d71f34728c4b
 ---> 64b567b9f946
Removing intermediate container d71f34728c4b
Step 12/12 : USER [secure]
 ---> Running in bb32718d6cec
 ---> d39432ec6310
Removing intermediate container bb32718d6cec
Successfully built d39432ec6310
...
travis_time:end:28aad670:start=1579779698768842702,finish=1579779773920792143,duration=75151949441,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:04540bb0[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/640854847/log.txt)