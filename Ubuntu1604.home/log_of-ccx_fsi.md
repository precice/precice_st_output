...
Job: [1583.22](https://travis-ci.org/precice/systemtests/jobs/645188342) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 2cab83b6db84
 ---> 4f893f46bd84
Removing intermediate container 2cab83b6db84
Step 3/12 : RUN apk add git bash
 ---> Running in 64256ab2f1fc
...
OK: 31 MiB in 25 packages
 ---> d922729da75c
Removing intermediate container 64256ab2f1fc
Step 4/12 : ARG branch=develop
 ---> Running in c2a4d518299a
 ---> 90fc72769469
Removing intermediate container c2a4d518299a
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 412d16553f31
[91mCloning into 'tutorials'...
[0m ---> b2633a6100cf
Removing intermediate container 412d16553f31
Step 6/12 : WORKDIR /
 ---> 7d26266fc99d
Removing intermediate container 5a9ea76030e3
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> f42be13316e1
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 4e2b35b366d9
 ---> 222667ab1ee4
Removing intermediate container 4e2b35b366d9
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in 07c22edc6bcf
 ---> b10b615a672a
Removing intermediate container 07c22edc6bcf
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in 43fdb42dcde1
 ---> 7868cc7b1bf5
Removing intermediate container 43fdb42dcde1
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in e5b0cbb12ab2
 ---> 0e469adf1798
Removing intermediate container e5b0cbb12ab2
Step 12/12 : USER [secure]
 ---> Running in c36eb85f63e4
 ---> 6677a96244c7
Removing intermediate container c36eb85f63e4
Successfully built 6677a96244c7
...
travis_time:end:01aab094:start=1580680139061847486,finish=1580680214418082589,duration=75356235103,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:0530464e[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/645188342/log.txt)