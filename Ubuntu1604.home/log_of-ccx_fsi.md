## Status: Failure 
Build: [1604](https://travis-ci.org/precice/systemtests/builds/646178651) 

Job: [1604.22](https://travis-ci.org/precice/systemtests/jobs/646178675) 

Triggered by: [pull_request](https://github.com/precice/systemtests/pull/173) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 7eec90f490f7
 ---> d8e0a8eb53c8
Removing intermediate container 7eec90f490f7
Step 3/12 : RUN apk add git bash
 ---> Running in 5a518f9c2209
...
OK: 31 MiB in 25 packages
 ---> c77ae15ce77f
Removing intermediate container 5a518f9c2209
Step 4/12 : ARG branch=develop
 ---> Running in 73c720c60bd5
 ---> 3ebcba0ff118
Removing intermediate container 73c720c60bd5
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in cc043f4aa45f
[91mCloning into 'tutorials'...
[0m ---> 916bd302dd8e
Removing intermediate container cc043f4aa45f
Step 6/12 : WORKDIR /
 ---> 3e8bae88967f
Removing intermediate container ab5c674c8272
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> d521a4b69df3
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 4f6751d4ebdf
 ---> b2775f1d4a52
Removing intermediate container 4f6751d4ebdf
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in a1a0d8a80f05
 ---> 46739e3beed7
Removing intermediate container a1a0d8a80f05
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in 5a072258b4e0
 ---> 39efe51d5afd
Removing intermediate container 5a072258b4e0
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 9ddb98913fd2
 ---> 791a8aa8c2d4
Removing intermediate container 9ddb98913fd2
Step 12/12 : USER [secure]
 ---> Running in e7b1ff69a816
 ---> 234e0c66f4ca
Removing intermediate container e7b1ff69a816
Successfully built 234e0c66f4ca
...
The following files exist in only one folder:
...
travis_time:end:0a72a150:start=1580860108939195342,finish=1580860184630276401,duration=75691081059,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:01940640[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/646178675/log.txt)