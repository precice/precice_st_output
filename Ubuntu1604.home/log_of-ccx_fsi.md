...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 0526f3baf61e
 ---> acfac00f47f2
Removing intermediate container 0526f3baf61e
Step 3/12 : RUN apk add git bash
 ---> Running in 29018e976b5b
...
OK: 31 MiB in 25 packages
 ---> f2dd1795a7ef
Removing intermediate container 29018e976b5b
Step 4/12 : ARG branch=develop
 ---> Running in 0e6184e30bc0
 ---> 9ea6a8ec35cb
Removing intermediate container 0e6184e30bc0
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 66c4975c7e21
[91mCloning into 'tutorials'...
[0m ---> f083d5e0f922
Removing intermediate container 66c4975c7e21
Step 6/12 : WORKDIR /
 ---> 7b57e0e15099
Removing intermediate container 450016c26ee9
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> 84bdffe00173
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in f2cf6e931b73
 ---> ac6410f9fbff
Removing intermediate container f2cf6e931b73
...
travis_time:end:2e91276e:start=1578780815121029374,finish=1578780826966931766,duration=11845902392,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:10b771bd[0K$ python push.py -t of-ccx_fsi
