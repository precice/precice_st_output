...
Job: [1575.22](https://travis-ci.org/precice/systemtests/jobs/644736973) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 3867124de9df
 ---> d715eb0e3770
Removing intermediate container 3867124de9df
Step 3/12 : RUN apk add git bash
 ---> Running in 9787076603e8
...
OK: 31 MiB in 25 packages
 ---> bcb737742da3
Removing intermediate container 9787076603e8
Step 4/12 : ARG branch=develop
 ---> Running in aae5c5b4f958
 ---> b7500e6bf827
Removing intermediate container aae5c5b4f958
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 1538485bb12a
[91mCloning into 'tutorials'...
[0m ---> 0540d7e8224e
Removing intermediate container 1538485bb12a
Step 6/12 : WORKDIR /
 ---> ff3676b9907e
Removing intermediate container 02a4c89f101c
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> 2be6d8b88441
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in e4491a00f874
 ---> 2c3426ed60ba
Removing intermediate container e4491a00f874
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in 100ce51d0907
 ---> 103f51208694
Removing intermediate container 100ce51d0907
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in e4f79797f152
 ---> 882a1152c27a
Removing intermediate container e4f79797f152
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in bed286ccdc67
 ---> efc1ceb83e17
Removing intermediate container bed286ccdc67
Step 12/12 : USER [secure]
 ---> Running in 06e759b835f3
 ---> 2ee759cf15a8
Removing intermediate container 06e759b835f3
Successfully built 2ee759cf15a8
...
travis_time:end:132367f8:start=1580563834438025878,finish=1580563910684066896,duration=76246041018,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:11cd5b92[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/644736973/log.txt)