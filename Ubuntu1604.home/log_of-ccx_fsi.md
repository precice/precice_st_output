...
Step 2/11 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in f123bfcfbd64
 ---> 2f285375cae8
Removing intermediate container f123bfcfbd64
Step 3/11 : RUN apk add git bash
 ---> Running in 2638aba27100
...
OK: 30 MiB in 25 packages
 ---> a7dbff977169
Removing intermediate container 2638aba27100
Step 4/11 : RUN git clone https://github.com/[secure]/tutorials
 ---> Running in 3e25ab28a316
[91mCloning into 'tutorials'...
[0m ---> 160ce524e809
Removing intermediate container 3e25ab28a316
Step 5/11 : WORKDIR /
 ---> a5f3eaf4c8e3
Removing intermediate container dff461fe5809
...
Step 7/11 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 28c0b36c0a3f
 ---> 24650b0612ea
Removing intermediate container 28c0b36c0a3f
Step 8/11 : RUN mkdir configs &&      sed 's|distribution-type="gather-scatter"|distribution-type="gather-scatter" exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g'     $tutorial_path/[secure]-config_serial.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in d09178f82efd
 ---> c911b39a36c4
Removing intermediate container d09178f82efd
Step 9/11 : RUN rm $tutorial_path/[secure]-config_serial.xml $tutorial_path/[secure]-config.xml
 ---> Running in 4655cd3f807f
 ---> bd037abd8547
Removing intermediate container 4655cd3f807f
Step 10/11 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 5fc534f50355
 ---> 22e5a3083f8c
Removing intermediate container 5fc534f50355
Step 11/11 : USER [secure]
 ---> Running in 398c39ceafc5
 ---> 4af6738fda10
Removing intermediate container 398c39ceafc5
Successfully built 4af6738fda10
Successfully tagged testcomposeofccxfsiubuntu1604homepetsc_tutorial-data:latest
Image for service tutorial-data was built because it did not already exist. To rebuild this image you must use `docker-compose build` or `docker-compose up --build`.
Pulling openfoam-adapter-fluid ([secure]/openfoam-adapter-ubuntu1604.home.petsc-develop:latest)...
latest: Pulling from [secure]/openfoam-adapter-ubuntu1604.home.petsc-develop
Digest: sha256:3c1fc69612d317f7baa53bef98ae816a2c234a8a78e3f245629f188379ccaf60
Status: Downloaded newer image for [secure]/openfoam-adapter-ubuntu1604.home.petsc-develop:latest
Pulling calculix-adapter-solid ([secure]/calculix-adapter-ubuntu1604.home.petsc-develop:latest)...
latest: Pulling from [secure]/calculix-adapter-ubuntu1604.home.petsc-develop
Digest: sha256:ba54599d4401e3cd17b72399bbc45208c401343057ca61125670de784df0414d
...
travis_time:end:162018ae:start=1571218605225066045,finish=1571218754287534311,duration=149062468266,event=script[0K[32;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:177cc0e4[0K$ python push.py -s -t of-ccx_fsi
Cloning into '[secure]_st_output'...
 ```
[Full job log](https://api.travis-ci.org/v3/job/598541179/log.txt)