...
Job: [1448.26](https://travis-ci.org/precice/systemtests/jobs/635927623) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 500a1449ddbb
 ---> f958ff40f68a
Removing intermediate container 500a1449ddbb
Step 3/12 : RUN apk add git bash
 ---> Running in 8b42967916bb
...
OK: 31 MiB in 25 packages
 ---> 37794d77e659
Removing intermediate container 8b42967916bb
Step 4/12 : ARG branch=develop
 ---> Running in 6edb3cb627ba
 ---> 8335895b2eb9
Removing intermediate container 6edb3cb627ba
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 4333e4c367d1
[91mCloning into 'tutorials'...
[0m ---> 328a50109c86
Removing intermediate container 4333e4c367d1
Step 6/12 : WORKDIR /
 ---> 466aae3c7cde
Removing intermediate container 03eb9705fbdf
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> 8e7381f374c4
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 13f71b32f08b
 ---> 88c7fdd34a6c
Removing intermediate container 13f71b32f08b
...
travis_time:end:05282976:start=1578829108836059930,finish=1578829120127789206,duration=11291729276,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:08604d1a[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/635927623/log.txt)