...
### Job: [943.21](https://travis-ci.org/precice/systemtests/jobs/598822103) 
...
Step 2/11 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in dccf29236453
 ---> a80205614ee2
Removing intermediate container dccf29236453
Step 3/11 : RUN apk add git bash
 ---> Running in 64a61736359f
...
OK: 30 MiB in 25 packages
 ---> c5e3510ff6d9
Removing intermediate container 64a61736359f
Step 4/11 : RUN git clone https://github.com/[secure]/tutorials
 ---> Running in d64827495140
[91mCloning into 'tutorials'...
[0m ---> a1d2d0733970
Removing intermediate container d64827495140
Step 5/11 : WORKDIR /
 ---> 6e8025d2c305
Removing intermediate container 9adf906f5ec5
...
Step 7/11 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 9a747fa8f57d
 ---> 436fe1279eb2
Removing intermediate container 9a747fa8f57d
Step 8/11 : RUN mkdir configs &&      sed 's|distribution-type="gather-scatter"|distribution-type="gather-scatter" exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g'     $tutorial_path/[secure]-config_serial.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in 629b0a58f404
 ---> 10cdb9219f93
Removing intermediate container 629b0a58f404
Step 9/11 : RUN rm $tutorial_path/[secure]-config_serial.xml $tutorial_path/[secure]-config.xml
 ---> Running in e87d4f1d298b
 ---> 13b4d912dc2c
Removing intermediate container e87d4f1d298b
Step 10/11 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in cb3eeb9a32c1
 ---> 557ced428b1c
Removing intermediate container cb3eeb9a32c1
Step 11/11 : USER [secure]
 ---> Running in c2a67eda5ca4
 ---> 28cb484a26a8
Removing intermediate container c2a67eda5ca4
Successfully built 28cb484a26a8
...
travis_time:end:02d7bbf1:start=1571254238489362223,finish=1571254384434288273,duration=145944926050,event=script[0K[32;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:00095524[0K$ python push.py -s -t of-ccx_fsi
Cloning into '[secure]_st_output'...
 ```
[Full job log](https://api.travis-ci.org/v3/job/598822103/log.txt)