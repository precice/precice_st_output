## Status: Failure 
Build: [1478](https://travis-ci.org/precice/systemtests/builds/640855140) 

Job: [1478.9](https://travis-ci.org/precice/systemtests/jobs/640855149) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 07e7086ff0ff
 ---> 159f129de27b
Removing intermediate container 07e7086ff0ff
Step 3/12 : RUN apk add git bash
 ---> Running in 69ee2d32552e
...
OK: 31 MiB in 25 packages
 ---> 4036232d61a8
Removing intermediate container 69ee2d32552e
Step 4/12 : ARG branch=develop
 ---> Running in 3c5c3cd5a633
 ---> d8306b263158
Removing intermediate container 3c5c3cd5a633
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 3538c89be8f5
[91mCloning into 'tutorials'...
[0m ---> 174983da60d3
Removing intermediate container 3538c89be8f5
Step 6/12 : WORKDIR /
 ---> 1de74acaa5b5
Removing intermediate container 52cdde681ff7
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> 123e9169922c
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 84bd77c8fb9c
 ---> fdc3e236d6da
Removing intermediate container 84bd77c8fb9c
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in cbb5060c2773
 ---> 53a8c4af3445
Removing intermediate container cbb5060c2773
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in 2751531dadd1
 ---> ac983f75f68a
Removing intermediate container 2751531dadd1
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 100797a14641
 ---> b96d7870d8be
Removing intermediate container 100797a14641
Step 12/12 : USER [secure]
 ---> Running in cb4920f6ae62
 ---> 65792cf0f449
Removing intermediate container cb4920f6ae62
Successfully built 65792cf0f449
...
travis_time:end:115c14c2:start=1579780530046271540,finish=1579780606322741374,duration=76276469834,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:091143fc[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/640855149/log.txt)