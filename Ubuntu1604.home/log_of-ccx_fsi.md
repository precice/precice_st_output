...
Job: [1592.22](https://travis-ci.org/precice/systemtests/jobs/645857671) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 42f7f446c5f9
 ---> 2bfc82b592d4
Removing intermediate container 42f7f446c5f9
Step 3/12 : RUN apk add git bash
 ---> Running in bdd0860e6d37
...
OK: 31 MiB in 25 packages
 ---> f83baaf68ff9
Removing intermediate container bdd0860e6d37
Step 4/12 : ARG branch=develop
 ---> Running in 25cff5898ca3
 ---> 43e3b99d3403
Removing intermediate container 25cff5898ca3
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in a36f5a532585
[91mCloning into 'tutorials'...
[0m ---> 537089d92339
Removing intermediate container a36f5a532585
Step 6/12 : WORKDIR /
 ---> b5e3f3d2bf8c
Removing intermediate container 6554d18eff51
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> 44012c2c0829
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 0e664a2339ed
 ---> cba545ea7136
Removing intermediate container 0e664a2339ed
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in 382ce898ccb9
 ---> c7c9b5bb81ca
Removing intermediate container 382ce898ccb9
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in 949e95dbd2df
 ---> 78b09fe56b6a
Removing intermediate container 949e95dbd2df
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 846eefe1ab9f
 ---> 06d181d31906
Removing intermediate container 846eefe1ab9f
Step 12/12 : USER [secure]
 ---> Running in 95448a7df97d
 ---> 7fdd5bed143f
Removing intermediate container 95448a7df97d
Successfully built 7fdd5bed143f
...
travis_time:end:02f780d3:start=1580810018150962536,finish=1580810099240411345,duration=81089448809,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:0724fa49[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/645857671/log.txt)