...
Job: [1600.9](https://travis-ci.org/precice/systemtests/jobs/645903432) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 6b58aec1b579
 ---> 6233646d08c1
Removing intermediate container 6b58aec1b579
Step 3/12 : RUN apk add git bash
 ---> Running in d2c114f777c1
...
OK: 31 MiB in 25 packages
 ---> db2d2b03934c
Removing intermediate container d2c114f777c1
Step 4/12 : ARG branch=develop
 ---> Running in 090bbfc78572
 ---> 3200506510fa
Removing intermediate container 090bbfc78572
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 9f3932c7a54f
[91mCloning into 'tutorials'...
[0m ---> 9b3920c919c3
Removing intermediate container 9f3932c7a54f
Step 6/12 : WORKDIR /
 ---> d0d118dedcb6
Removing intermediate container d16b630d328d
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> c329113edd87
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 5c4a10187725
 ---> 24a6d46d4e88
Removing intermediate container 5c4a10187725
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in 3447c70601b6
 ---> 588afcfb4c8e
Removing intermediate container 3447c70601b6
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in 0fb5b305182f
 ---> 798821d1d53c
Removing intermediate container 0fb5b305182f
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in b0a4fcafbd5e
 ---> 1ce1a60214b4
Removing intermediate container b0a4fcafbd5e
Step 12/12 : USER [secure]
 ---> Running in caeb2b1b68cb
 ---> 20cf9baf679c
Removing intermediate container caeb2b1b68cb
Successfully built 20cf9baf679c
...
travis_time:end:1f3c6b20:start=1580816420096174965,finish=1580816495586654429,duration=75490479464,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:047d97c7[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/645903432/log.txt)