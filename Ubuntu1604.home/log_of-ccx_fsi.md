## Status: Failure 
Build: [1489](https://travis-ci.org/precice/systemtests/builds/641375347) 

Job: [1489.22](https://travis-ci.org/precice/systemtests/jobs/641375384) 

Triggered by: [pull_request](https://github.com/precice/systemtests/pull/157) 
...
Step 2/12 : ENV tutorial_path /tutorials/FSI/flap_perp/OpenFOAM-CalculiX
 ---> Running in 7f449edec3f4
 ---> 22953b998bf9
Removing intermediate container 7f449edec3f4
Step 3/12 : RUN apk add git bash
 ---> Running in c44baba0d9bf
...
OK: 31 MiB in 25 packages
 ---> f9d490d6c427
Removing intermediate container c44baba0d9bf
Step 4/12 : ARG branch=develop
 ---> Running in f7b38abda534
 ---> fcf1eae3cf47
Removing intermediate container f7b38abda534
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 20cc884786e2
[91mCloning into 'tutorials'...
[0m ---> 47736f165427
Removing intermediate container 20cc884786e2
Step 6/12 : WORKDIR /
 ---> 555eff99894d
Removing intermediate container eae7e00d7a5d
Step 7/12 : COPY interface_beam.nam fix1_beam.nam all.msh $tutorial_path/Solid/
 ---> c7d1e56cfbb9
Step 8/12 : RUN sed -i '/application     pimpleFoam/d; s/\/\/ application     pimpleDyMFoam/application    pimpleDyMFoam/g'     $tutorial_path/Fluid/system/controlDict
 ---> Running in 5ca107688d6e
 ---> cdca2161e55c
Removing intermediate container 5ca107688d6e
Step 9/12 : RUN mkdir configs &&      sed -e 's|<m2n:sockets from=\"Fluid\" to=\"Calculix\"|<m2n:sockets from=\"Fluid\" to=\"Calculix\" exchange-directory=\"/home/[secure]/Data/Exchange/\" network=\"eth0\"/>|g'     $tutorial_path/[secure]-config.xml > configs/[secure]-config.xml && cp $tutorial_path/config.yml configs/
 ---> Running in dc1eb2581d7f
 ---> d32ccff0d7ff
Removing intermediate container dc1eb2581d7f
Step 10/12 : RUN rm $tutorial_path/[secure]-config.xml
 ---> Running in 0ebce3bfa595
 ---> 8431c5cf9fa9
Removing intermediate container 0ebce3bfa595
Step 11/12 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 0d71ced5d5d7
 ---> 49e05add04e6
Removing intermediate container 0d71ced5d5d7
Step 12/12 : USER [secure]
 ---> Running in 3650237f816a
 ---> 8fde29f6aa5a
Removing intermediate container 3650237f816a
Successfully built 8fde29f6aa5a
...
travis_time:end:156dafde:start=1579878207730658217,finish=1579878285231342171,duration=77500683954,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx_fsi --base Ubuntu1604.home.PETSc" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:010a2e6a[0K$ python push.py -t of-ccx_fsi
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/641375384/log.txt)