...
Job: [1457.23](https://travis-ci.org/precice/systemtests/jobs/637357754) 
...
Step 2/12 : ENV tutorial_path tutorials/FSI/flap_perp/OpenFOAM-deal.II
 ---> Running in a40f97a33269
 ---> 4f0974a6f6f3
Removing intermediate container a40f97a33269
Step 3/12 : RUN apk add git
 ---> Running in 2260b3157bb6
...
OK: 22 MiB in 20 packages
 ---> 0eb310dee3c2
Removing intermediate container 2260b3157bb6
Step 4/12 : ARG branch=develop
 ---> Running in e83ca04ccbae
 ---> 734822f79fa4
Removing intermediate container e83ca04ccbae
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 500470e26c56
[91mCloning into 'tutorials'...
[0m ---> 949b502ed99d
Removing intermediate container 500470e26c56
Step 6/12 : RUN mkdir configs && sed -e 's|gather-scatter"|gather-scatter" exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g' $tutorial_path/[secure]-config_serial.xml > configs/[secure]-config.xml
 ---> Running in f30c0b9cbeb3
...
travis_time:end:067f43c4:start=1579090085940384502,finish=1579090095947151217,duration=10006766715,event=script[0K[31;1mThe command "python system_testing.py -s dealii-of" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:0137be18[0K$ python push.py -t dealii-of
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/637357754/log.txt)