...
Job: [1442.6](https://travis-ci.org/precice/systemtests/jobs/635918224) 
...
Step 2/12 : ENV tutorial_path tutorials/FSI/flap_perp/OpenFOAM-deal.II
 ---> Running in 3f96f790e90c
 ---> eea21ebf8180
Removing intermediate container 3f96f790e90c
Step 3/12 : RUN apk add git
 ---> Running in d388f879678e
...
OK: 22 MiB in 20 packages
 ---> e279934ecf0b
Removing intermediate container d388f879678e
Step 4/12 : ARG branch=develop
 ---> Running in c01750c3421a
 ---> 84968efd7e3f
Removing intermediate container c01750c3421a
Step 5/12 : RUN git clone --branch $branch https://github.com/[secure]/tutorials
 ---> Running in 4dbfc1b8e41a
[91mCloning into 'tutorials'...
[0m ---> 8ac8bbdf7dc3
Removing intermediate container 4dbfc1b8e41a
Step 6/12 : RUN mkdir configs && sed -e 's|gather-scatter"|gather-scatter" exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g' $tutorial_path/[secure]-config_serial.xml > configs/[secure]-config.xml
 ---> Running in 6fb510452bc0
...
travis_time:end:05d17c84:start=1578822618319028940,finish=1578822628954331273,duration=10635302333,event=script[0K[31;1mThe command "python system_testing.py -s dealii-of" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:087dc020[0K$ python push.py -t dealii-of
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/635918224/log.txt)