...
Job: [1587.18](https://travis-ci.org/precice/systemtests/jobs/645394816) 
...
travis_time:end:2fc5788c:start=1580730170006054067,finish=1580730175780266664,duration=5774212597,event=checkout[0Ktravis_time:start:1af3e066[0K
...
travis_time:end:1af3e066:start=1580730175784689203,finish=1580730175795389166,duration=10699963,event=env[0Ktravis_time:start:108d0431[0K$ source ~/virtualenv/python3.5/bin/activate
travis_time:end:108d0431:start=1580730175800150814,finish=1580730175805678124,duration=5527310,event=[0K$ python --version
Python 3.5.6
$ pip --version
pip 18.0 from /home/travis/virtualenv/python3.5.6/lib/python3.5/site-packages/pip (python 3.5)
Could not locate requirements.txt. Override the install: key in your .travis.yml to install dependencies.
travis_time:start:1466394c[0K$ python system_testing.py -s of-of
networks:
  [secure]comm: {}
services:
...
travis_time:end:1466394c:start=1580730176088718191,finish=1580730304953514660,duration=128864796469,event=script[0K[32;1mThe command "python system_testing.py -s of-of" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:027de1cb[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.14
Parsing documentation for dpl-1.10.14
Installing ri documentation for dpl-1.10.14
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:027de1cb:start=1580730309123668977,finish=1580730310477497226,duration=1353828249,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:1454eeea[0KSuccessfully installed dpl-script-1.10.14
...
```
[
Full job log](https://api.travis-ci.org/v3/job/645394816/log.txt)