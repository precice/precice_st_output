...
Job: [1032.17](https://travis-ci.org/precice/systemtests/jobs/603569002) 
...
preCICE:[0m it 1 of 3 | dt# 11 of 10 | t 10 | dt 1 | max dt 1 | ongoing no | dt complete yes | 
 DUMMY: Advancing in time
preCICE:[0m Timestep c                      initializeData/map.nn.mapData.FromMeshTwoToMeshOne |          1 |          0 |          0 |          0 |          0 |          0 |
                           initializeData/map.np.mapData.FromMeshOneToMeshTwo |          1 |          0 |          0 |          0 |          0 |          0 |
                                                               solver.advance |         30 |          0 |          0 |          0 |          0 |          0 |
                                                            solver.initialize |          1 |          1 |          1 |          1 |          1 |   0.000778 |


Run finished at Sun Oct 27 18:02:05 2019
Global runtime       = 1303ms / 1.303s
Number of processors = 1
# Rank: 0

                                       Event |      Count |  Total[ms] |    Max[ms] |    Min[ms] |    Avg[ms] | Time Ratio |
----------------------------------------------------------------------------------------------------------------------------
                                     _GLOBAL |          1 |       1303 |       1303 |       1303 |       1303 |          1 |
                                     advance |         30 |       1234 |         75 |         39 |         41 |      0.947 |
                                   configure |          1 |          0 |          0 |          0 |          0 |          0 |
                                    finalize |          1 |         42 |         42 |         42 |         42 |     0.0322 |
                                  initialize |          1 |         24 |         24 |         24 |         24 |     0.0184 |
      initialize/m2n.requestMasterConnection |          1 |         19 |         19 |         19 |         19 |     0.0146 |
      initialize/m2n.requestSlavesConnection |          1 |          0 |          0 |          0 |          0 |          0 |
   initialize/partition.feedbackMesh.MeshOne |          1 |          0 |          0 |          0 |          0 |          0 |
     initialize/partition.gatherMesh.MeshOne |          1 |          1 |          1 |          1 |          1 |   0.000767 |
...
---------------------------------------------------------------------------------------------------------------
 ...
 ---> ee972ef8993c
Removing intermediate container e3e44b5f67cf
Step 29/29 : RUN mkdir /Output
 ---> Running in da58f4703fbc
 ---> b8b17e0a5cec
Removing intermediate container da58f4703fbc
Successfully built b8b17e0a5cec
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
f030bdc95f99c3abe637cb794a65d32a932dbdbeac1fca6779297dfa1914ef20
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:0860fdd5:start=1572199178599973650,finish=1572199326051697654,duration=147451724004,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:08ae6cc4[0K$ python push.py -s -t bindings
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/603569002/log.txt)