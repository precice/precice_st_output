...
Job: [1157.17](https://travis-ci.org/precice/systemtests/jobs/617667629) 
...
```
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |         29 |          0 |          0 |          0 |          0 |          0 |
                                        ...
                                        initialize/m2n.acceptMasterConnection |          1 |          6 |          6 |          6 |          6 |    0.00467 |
...
Run finished at Wed Nov 27 12:11:54 2019
...
----------------------------------------------------------------------------------------------------------------------------
                                     ...
                                     advance |         30 |       1235 |         77 |         39 |         41 |      0.946 |
                                   configure |          1 |          0 |          0 |          0 |          0 |          0 |
                                    finalize |          1 |         41 |         41 |         41 |         41 |     0.0314 |
                                  initialize |          1 |         18 |         18 |         18 |         18 |     0.0138 |
      initialize/m2n.requestMasterConnection |          1 |          9 |          9 |          9 |          9 |     0.0069 |
 ...
 initialize/partition.sendGlobalMesh.MeshOne |          1 |          0 |          0 |          0 |          0 |          0 |
                           ...
                           solver.initialize |          1 |          8 |          8 |          8 |          8 |    0.00613 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 ---> c655f0358f05
Removing intermediate container b621e12db69b
Step 29/29 : RUN mkdir /Output
 ---> Running in fc32e43e068e
 ---> 7c94cdce6dff
Removing intermediate container fc32e43e068e
Successfully built 7c94cdce6dff
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
99201bce2691ba6d26bd5dfa821a9f44dbf59b8bf1170dc78dbd320d33391e14
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:1061a598:start=1574856578503927379,finish=1574856715903729978,duration=137399802599,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:08722770[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.14
Parsing documentation for dpl-1.10.14
Installing ri documentation for dpl-1.10.14
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:08722770:start=1574856720706078201,finish=1574856722377380848,duration=1671302647,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:180323c1[0Ktravis_fold:start:dpl.1[33mInstalling deploy dependencies[0m
...
```
[
Full job log](https://api.travis-ci.org/v3/job/617667629/log.txt)