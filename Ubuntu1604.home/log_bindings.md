## Status: Passing 
Build: [964](https://travis-ci.org/precice/systemtests/builds/599690910) 

Job: [964.17](https://travis-ci.org/precice/systemtests/jobs/599690927) 

Triggered by: [push](https://github.com/precice/systemtests/compare/4d3aff117aa2...3b3e78e6370b) 

Last 100 lines of the job log at the moment of push:
---
```
----------------------------------------------------------------------------------------------------------------------------
                                     _GLOBAL |          1 |       1336 |       1336 |       1336 |       1336 |          1 |
                                     advance |         30 |       1241 |         83 |         39 |         41 |      0.929 |
                                   configure |          1 |          0 |          0 |          0 |          0 |          0 |
                                    finalize |          1 |         40 |         40 |         40 |         40 |     0.0299 |
                                  initialize |          1 |         51 |         51 |         51 |         51 |     0.0382 |
      initialize/m2n.requestMasterConnection |          1 |         49 |         49 |         49 |         49 |     0.0367 |
 ...
 initialize/partition.sendGlobalMesh.MeshOne |          1 |          0 |          0 |          0 |          0 |          0 |
                              ...
                              solver.advance |         30 |          1 |          0 |          0 |          0 |   0.000749 |
                           solver.initialize |          1 |          1 |          1 |          1 |          1 |   0.000749 |


                                                                        Event |      Count |  Total[ms] |    Max[ms] |    Min[ms] |    Avg[ms] | Time Ratio |
-------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                                      _GLOBAL |          1 |       1293 |       1293 |       1293 |       1293 |          1 |
                                                                      advance |         30 |       1163 |         44 |          0 |         38 |      0.899 |
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |         29 |          0 |          0 |          0 |          0 |          0 |
                                        ...
                                        initialize/m2n.acceptMasterConnection |          1 |          4 |          4 |          4 |          4 |    0.00309 |
 ...
 initializeData/map.nn.computeMapping.FromMeshTwoToMeshOne.getIndexOnVertices |          1 |          0 |          0 |          0 |          0 |          0 |
                           ...
                           initializeData/map.np.mapData.FromMeshOneToMeshTwo |          1 |          0 |          0 |          0 |          0 |          0 |
                                                            ...
                                                            solver.initialize |          1 |          5 |          5 |          5 |          5 |    0.00387 |


                                        Name |        Max |  MaxOnRank |        Min |  MinOnRank |    Min/Max |
---------------------------------------------------------------------------------------------------------------
                                     _GLOBAL |       1336 |          0 |       1336 |          0 |          1 |
                                     advance |         83 |          0 |         39 |          0 |    0.46988 |
                                   configure |          0 |          0 |          0 |          0 |          0 |
                                    finalize |         40 |          0 |         40 |          0 |          1 |
                                  initialize |         51 |          0 |         51 |          0 |          1 |
      initialize/m2n.requestMasterConnection |         49 |          0 |         49 |          0 |          1 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> 10269a1ee1af
Removing intermediate container 0532aa64a56a
Step 29/29 : RUN mkdir /Output
 ---> Running in 8b2c1a365750
 ---> bb95c450e059
Removing intermediate container 8b2c1a365750
Successfully built bb95c450e059
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
52b872aa906d04401d13fbe6e1853651f3eace402d1e42b8d1b4076097c6e501
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:04e72ce8:start=1571411208946184934,finish=1571411369194354691,duration=160248169757,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:29467c10[0K$ python push.py -s -t bindings
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/599690927/log.txt)