...
Job: [1454.22](https://travis-ci.org/precice/systemtests/jobs/636821330) 
...
```
                               ...
                               initialize/partition.receiveGlobalMesh.MeshOne |          1 |         37 |         37 |         37 |         37 |      0.192 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |          0 |          0 |          0 |          0 |          0 |
                                                                   ...
                                                                   initialize |        100 |          0 |        100 |          0 |          1 |
                                        initialize/m2n.acceptMasterConnection |         19 |          0 |         19 |          0 |          1 |
...
eData/map.np.mapData.FromMeshOneToMeshTwo |          0 |          0 |          0 |          0 |          0 |
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> bf038bea7142
Removing intermediate container 0636fc971093
Step 27/29 : USER root
 ---> Running in ce7e646b47fc
 ---> c1f3491b48ee
Removing intermediate container ce7e646b47fc
Step 28/29 : RUN mkdir /Output
 ---> Running in c5ba9a9a4ab9
 ---> fe838990d949
Removing intermediate container c5ba9a9a4ab9
Step 29/29 : USER [secure]
 ---> Running in cf813b2c4598
 ---> fdd03cfef486
Removing intermediate container cf813b2c4598
Successfully built fdd03cfef486
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
ff0e3507f8d865a9d2ffc03dc706d4418045912678bc24940035c08a38012c9f
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:17a405cb:start=1579001604535125080,finish=1579001709383458351,duration=104848333271,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:0076a7c0[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
...
```
[
Full job log](https://api.travis-ci.org/v3/job/636821330/log.txt)