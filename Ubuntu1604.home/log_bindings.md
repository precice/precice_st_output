...
Job: [1231.17](https://travis-ci.org/precice/systemtests/jobs/618755790) 
...
```
 initialize/partition.sendGlobalMesh.MeshOne |          1 |          0 |          0 |          0 |          0 |          0 |
                              ...
                              solver.advance |         30 |          2 |          0 |          0 |          0 |    0.00156 |
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 initializeData/map.nn.computeMapping.FromMeshTwoToMeshOne.getIndexOnVertices |          1 |          0 |          0 |          0 |          0 |          0 |
                           ...
                           initializeData/map.np.mapData.FromMeshOneToMeshTwo |          1 |          0 |          0 |          0 |          0 |          0 |
                                                            ...
                                                            solver.initialize |          1 |          4 |          4 |          4 |          4 |    0.00311 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> 31a502797343
Removing intermediate container 12a78a4d4d16
Step 25/25 : RUN mkdir /Output
 ---> Running in 6d8db98603b2
 ---> edd14a632e8c
Removing intermediate container 6d8db98603b2
Successfully built edd14a632e8c
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
f33e4afefcf31c24f752d5870ed20c47cb26e80bb5245a4b58bd53de6bb08177
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:01c532d9:start=1575065890826685786,finish=1575066029630546919,duration=138803861133,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:12da42e5[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.14
Parsing documentation for dpl-1.10.14
Installing ri documentation for dpl-1.10.14
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:12da42e5:start=1575066034639114674,finish=1575066036367831181,duration=1728716507,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:055b89c0[0KSuccessfully installed dpl-script-1.10.14
...
```
[
Full job log](https://api.travis-ci.org/v3/job/618755790/log.txt)