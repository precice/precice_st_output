...
Job: [1221.17](https://travis-ci.org/precice/systemtests/jobs/618379317) 
...
------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> 4ba15c315f23
Removing intermediate container b9285cf91647
Step 27/29 : USER root
 ---> Running in b0366bdd4159
 ---> 6c2a0086f5d7
Removing intermediate container b0366bdd4159
Step 28/29 : RUN mkdir /Output
 ---> Running in 41551791dcf0
 ---> 7d53b0bf6c9d
Removing intermediate container 41551791dcf0
Step 29/29 : USER [secure]
 ---> Running in 9a9776748d63
 ---> d8afa28d3ba2
Removing intermediate container 9a9776748d63
Successfully built d8afa28d3ba2
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
6031cb055c24a0ad0add817ec257b0545d4066d915215ada6dcf4a580637ebd2
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:1ce1e8ee:start=1575014805763902629,finish=1575014937590008913,duration=131826106284,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m
...
1 gem installed
travis_time:end:0437c3b0:start=1575014942235528231,finish=1575014943918676246,duration=1683148015,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:0a0c9030[0Ktravis_fold:start:dpl.1[33mInstalling deploy dependencies[0m
...
```
[
Full job log](https://api.travis-ci.org/v3/job/618379317/log.txt)