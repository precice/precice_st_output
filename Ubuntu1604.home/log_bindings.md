...
Job: [1215.17](https://travis-ci.org/precice/systemtests/jobs/618378127) 
...
```
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |         29 |          0 |          0 |          0 |          0 |          0 |
                                        ...
                                        initialize/m2n.acceptMasterConnection |          1 |         11 |         11 |         11 |         11 |    0.00853 |
...
----------------------------------------------------------------------------------------------------------------------------
                                     ...
                                     advance |         30 |       1229 |         71 |         39 |         40 |       0.96 |
                                   configure |          1 |          2 |          2 |          2 |          2 |    0.00156 |
                                    finalize |          1 |         40 |         40 |         40 |         40 |     0.0312 |
                                  initialize |          1 |          6 |          6 |          6 |          6 |    0.00469 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |          0 |          0 |          0 |          0 |          0 |
                                        ...
                                        initialize/m2n.acceptMasterConnection |         11 |          0 |         11 |          0 |          1 |
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> 1b361b79091f
Removing intermediate container cb819de256ed
Step 25/25 : RUN mkdir /Output
 ---> Running in 7fc78e24031f
 ---> 0fccbb46bd47
Removing intermediate container 7fc78e24031f
Successfully built 0fccbb46bd47
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
4deed014689960cd2168ef86dee5d94237745261324ddd8bd44253fd3016584e
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:004f96fb:start=1575001706709263640,finish=1575001835439554141,duration=128730290501,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:04404e7f[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.14
Parsing documentation for dpl-1.10.14
Installing ri documentation for dpl-1.10.14
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:04404e7f:start=1575001840070636244,finish=1575001841710042065,duration=1639405821,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:1611a83c[0K
```
[
Full job log](https://api.travis-ci.org/v3/job/618378127/log.txt)