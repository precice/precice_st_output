...
preCICE:[0m it 1 of 3 | dt# 11 of 10 | t 10 | dt 1 | max dt 1 | ongoing no | dt complete yes | 
 DUMMY: Advancing in time
Run finished at Thu Sep  5 13:30:28 2019
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |         29 |          0 |          0 |          0 |          0 |          0 |
                                                                    configure |          1 |         42 |         42 |         42 |         42 |     0.0326 |
...
----------------------------------------------------------------------------------------------------------------------------
                                     ...
                                     advance |         30 |       1237 |         79 |         39 |         41 |      0.961 |
                                   configure |          1 |         54 |         54 |         54 |         54 |      0.042 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 ---> e7e1ec6b37c0
Removing intermediate container 9f61295b5123
Step 29/29 : RUN mkdir /Output
 ---> Running in c07c22e8dcb4
 ---> d62ed3d4b7a1
Removing intermediate container c07c22e8dcb4
Successfully built d62ed3d4b7a1
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
66f07ddf6bdf894f90e279b7c8a4026ee3ec6213ad8c16ab0a6131f0fc2a1263
...
travis_time:end:2dc89089:start=1567689705015017514,finish=1567690230291557191,duration=525276539677,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:086324f2[0K$ python push.py -s -t bindings
Cloning into '[secure]_st_output'...
 ```
[Full job log](https://api.travis-ci.org/v3/job/581200539/log.txt)