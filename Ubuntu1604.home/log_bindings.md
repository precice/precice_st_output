...
Job: [1000.17](https://travis-ci.org/precice/systemtests/jobs/601988713) 
...
Run finished at Wed Oct 23 20:49:30 2019
...
----------------------------------------------------------------------------------------------------------------------------
                                     ...
                                     advance |         30 |       1231 |         72 |         39 |         41 |      0.953 |
                                   configure |          1 |          0 |          0 |          0 |          0 |          0 |
                                    finalize |          1 |         42 |         42 |         42 |         42 |     0.0325 |
                                  initialize |          1 |         15 |         15 |         15 |         15 |     0.0116 |
      initialize/m2n.requestMasterConnection |          1 |         10 |         10 |         10 |         10 |    0.00774 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> efdb410cba59
Removing intermediate container 8c9de0834e3f
Step 29/29 : RUN mkdir /Output
 ---> Running in d9eec0969e1f
 ---> 1b0f2af6a8a2
Removing intermediate container d9eec0969e1f
Successfully built 1b0f2af6a8a2
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
5867bad97c727a5a0667432bb1d50167846c9a3f8b459baf8043782c2031792c
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:2416770e:start=1571863631322415447,finish=1571863772253455704,duration=140931040257,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:11accccc[0K$ python push.py -s -t bindings
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/601988713/log.txt)