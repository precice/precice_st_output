...
Job: [1609.18](https://travis-ci.org/precice/systemtests/jobs/646351646) 
...
```
 initializeData/map.nn.computeMapping.FromMeshTwoToMeshOne.getIndexOnVertices |          1 |          0 |          0 |          0 |          0 |          0 |
                           ...
                           initializeData/map.np.mapData.FromMeshOneToMeshTwo |          1 |          0 |          0 |          0 |          0 |          0 |
                                                            ...
                                                            solver.initialize |          1 |          2 |          2 |          2 |          2 |     0.0146 |


                                                                         Name |        Max |  MaxOnRank |        Min |  MinOnRank |    Min/Max |
------------------------------------------------------------------------------------------------------------------------------------------------
                                                                      _GLOBAL |        137 |          0 |        137 |          0 |          1 |
                                                                      advance |         36 |          0 |          0 |          0 |          0 |
...
eData/map.np.mapData.FromMeshOneToMeshTwo |          0 |          0 |          0 |          0 |          0 |
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> 32c8f189a638
Removing intermediate container 37a3b2d1d265
Step 34/36 : USER root
 ---> Running in 5ec944e1cda5
 ---> 421eaddc20fe
Removing intermediate container 5ec944e1cda5
Step 35/36 : RUN mkdir /Output
 ---> Running in 96b4da6ab993
 ---> e2e45db4d1cd
Removing intermediate container 96b4da6ab993
Step 36/36 : USER [secure]
 ---> Running in 302b1aff32f5
 ---> b40e4caab946
Removing intermediate container 302b1aff32f5
Successfully built b40e4caab946
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
28503e4355d75a6affd2097d3e54e25eeb846922d9371d31dc1709c928631f3d
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
TEST SUCCEEDED - No difference to referenceOutput found.
travis_time:end:06d7d3a7:start=1580904322152699519,finish=1580904444919899547,duration=122767200028,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:13ecb16c[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.14
Parsing documentation for dpl-1.10.14
Installing ri documentation for dpl-1.10.14
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:13ecb16c:start=1580904449198698627,finish=1580904450659692595,duration=1460993968,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:030bcdc0[0KSuccessfully installed dpl-script-1.10.14
...
```
[
Full job log](https://api.travis-ci.org/v3/job/646351646/log.txt)