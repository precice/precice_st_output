...
Job: [1256.18](https://travis-ci.org/precice/systemtests/jobs/620607322) 
...
----------------------------------------------------------------------------------------------------------------------------
                                     ...
                                     advance |         30 |       1234 |         75 |         39 |         41 |      0.939 |
                                   configure |          1 |          0 |          0 |          0 |          0 |          0 |
                                    finalize |          1 |         40 |         40 |         40 |         40 |     0.0304 |
                                  initialize |          1 |         37 |         37 |         37 |         37 |     0.0282 |
      initialize/m2n.requestMasterConnection |          1 |         36 |         36 |         36 |         36 |     0.0274 |
 ...
 initialize/partition.sendGlobalMesh.MeshOne |          1 |          0 |          0 |          0 |          0 |          0 |
                              ...
                              solver.advance |         30 |          1 |          0 |          0 |          0 |   0.000761 |
...
---------------------------------------------------------------------------------------------------------------
                                  ...
                                  initialize |         37 |          0 |         37 |          0 |          1 |
      initialize/m2n.requestMasterConnection |         36 |          0 |         36 |          0 |          1 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> f6ca2b0a5083
Removing intermediate container c6d70f881c31
Step 27/29 : USER root
 ---> Running in 5fe686fee1d6
 ---> 1f6256053255
Removing intermediate container 5fe686fee1d6
Step 28/29 : RUN mkdir /Output
 ---> Running in 19fa05d73b06
 ---> ad5721bf8178
Removing intermediate container 19fa05d73b06
Step 29/29 : USER [secure]
 ---> Running in e082224ad5ba
 ---> 03f2a3d6d51e
Removing intermediate container e082224ad5ba
Successfully built 03f2a3d6d51e
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
7ac01cd769e15d4e0f634b3a10dbd772640734d41e4846b81aa33fd48d92552d
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:14eed5a8:start=1575467571143676561,finish=1575467696656528512,duration=125512851951,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:20f40d6b[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.14
Parsing documentation for dpl-1.10.14
Installing ri documentation for dpl-1.10.14
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:20f40d6b:start=1575467701019976061,finish=1575467702631053317,duration=1611077256,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:2390a241[0Ktravis_fold:start:dpl.1[33mInstalling deploy dependencies[0m
...
```
[
Full job log](https://api.travis-ci.org/v3/job/620607322/log.txt)