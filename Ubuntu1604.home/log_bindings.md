...
Job: [1600.5](https://travis-ci.org/precice/systemtests/jobs/645903428) 
...
---------------------------------------------------------------------------------------------------------------
 ...
 initialize/m2n.broadcastVertexDistributions |          0 |          0 |          0 |          0 |          0 |
   ...
   initialize/m2n.exchangeVertexDistribution |         74 |          0 |         74 |          0 |          1 |
      ...
      initialize/m2n.requestSlavesConnection |         76 |          0 |         76 |          0 |          1 |
...
eData/map.np.mapData.FromMeshOneToMeshTwo |          0 |          0 |          0 |          0 |          0 |
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> 54380d5fc618
Removing intermediate container 66e85b69c2ce
Step 34/36 : USER root
 ---> Running in 0cabc596cc15
 ---> 8defede6c692
Removing intermediate container 0cabc596cc15
Step 35/36 : RUN mkdir /Output
 ---> Running in 9a71edec39fa
 ---> 051b37a7b9eb
Removing intermediate container 9a71edec39fa
Step 36/36 : USER [secure]
 ---> Running in e6f5d5c3f2b4
 ---> 82aab33b4857
Removing intermediate container e6f5d5c3f2b4
Successfully built 82aab33b4857
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
b7972b7ca27a42e20e779103be7532d3c73e8c2063fa400eef57f06647143d48
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
TEST SUCCEEDED - No difference to referenceOutput found.
travis_time:end:0143fb88:start=1580816181415856700,finish=1580816308336287574,duration=126920430874,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:02ceb72c[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.14
Parsing documentation for dpl-1.10.14
Installing ri documentation for dpl-1.10.14
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:02ceb72c:start=1580816313180760928,finish=1580816314816888089,duration=1636127161,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:1368da2c[0Ktravis_fold:start:dpl.1[33mInstalling deploy dependencies[0m
...
```
[
Full job log](https://api.travis-ci.org/v3/job/645903428/log.txt)