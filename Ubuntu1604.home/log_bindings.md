...
```
 ----------------------------------------------------------------------------------------------------------------------------
                                     ...
                                     advance |         30 |       1238 |         76 |         39 |         41 |      0.956 |
                                   configure |          1 |          0 |          0 |          0 |          0 |          0 |
                                    finalize |          1 |         39 |         39 |         39 |         39 |     0.0301 |
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |         29 |          0 |          0 |          0 |          0 |          0 |
                                                                   ...
                                                                   initialize |          1 |         40 |         40 |         40 |         40 |     0.0311 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> a4db595d7dd0
Removing intermediate container 78a9a2236baa
Step 29/29 : RUN mkdir /Output
 ---> Running in 23c1d21b276e
 ---> 460a4a1fad6c
Removing intermediate container 23c1d21b276e
Successfully built 460a4a1fad6c
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
95101bbb38cef5b3e09ed351b06856705d3c1c52b9f138ea3ab3cda00650d22d
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:09563d6e:start=1571252854427791904,finish=1571252996474492628,duration=142046700724,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:2b5ff21c[0K$ python push.py -s -t bindings
Cloning into '[secure]_st_output'...
 ```
[Full job log](https://api.travis-ci.org/v3/job/598783709/log.txt)