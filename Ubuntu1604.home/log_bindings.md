...
Job: [1205.17](https://travis-ci.org/precice/systemtests/jobs/618334155) 
...
```
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |         29 |          0 |          0 |          0 |          0 |          0 |
                                                                    configure |          1 |          0 |          0 |          0 |          0 |          0 |
                                                                     finalize |          1 |         79 |         79 |         79 |         79 |     0.0599 |
                                                                   initialize |          1 |         76 |         76 |         76 |         76 |     0.0577 |
                                        initialize/m2n.acceptMasterConnection |          1 |         34 |         34 |         34 |         34 |     0.0258 |
                                        initialize/m2n.acceptSlavesConnection |          1 |          0 |          0 |          0 |          0 |          0 |
                        initialize/map.np.computeMapping.FromMeshOneToMeshTwo |          1 |          2 |          2 |          2 |          2 |    0.00152 |
     ...
     initialize/map.np.computeMapping.FromMeshOneToMeshTwo.getIndexOnVertices |          1 |          0 |          0 |          0 |          0 |          0 |
                               ...
                               initialize/partition.receiveGlobalMesh.MeshOne |          1 |         38 |         38 |         38 |         38 |     0.0288 |
...
Run finished at Fri Nov 29 18:37:00 2019
...
----------------------------------------------------------------------------------------------------------------------------
                                     ...
                                     advance |         30 |       1240 |         82 |         39 |         41 |      0.961 |
                                   configure |          1 |          0 |          0 |          0 |          0 |          0 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
                                                                      _GLOBAL |       1318 |          0 |       1318 |          0 |          1 |
                                                                      advance |         40 |          0 |          0 |          0 |          0 |
                                  advance/map.nn.mapData.FromMeshTwoToMeshOne |          0 |          0 |          0 |          0 |          0 |
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |          0 |          0 |          0 |          0 |          0 |
                                                                    configure |          0 |          0 |          0 |          0 |          0 |
                                                                     finalize |         79 |          0 |         79 |          0 |          1 |
                                                                   initialize |         76 |          0 |         76 |          0 |          1 |
 ...
 ---> e9c25de05005
Removing intermediate container 64043673e05a
Step 25/25 : RUN mkdir /Output
 ---> Running in 08d1c3ff57a7
 ---> 37583f22763f
Removing intermediate container 08d1c3ff57a7
Successfully built 37583f22763f
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
f7555063e5ac25e65d050395888ee25fdb8484398e7eae9c6fbf92c3205290a2
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:06220cda:start=1575052493613099273,finish=1575052621476229648,duration=127863130375,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:0090cce7[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.14
Parsing documentation for dpl-1.10.14
Installing ri documentation for dpl-1.10.14
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:0090cce7:start=1575052626125563375,finish=1575052627817847929,duration=1692284554,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:00383dd8[0KSuccessfully installed dpl-script-1.10.14
...
```
[
Full job log](https://api.travis-ci.org/v3/job/618334155/log.txt)