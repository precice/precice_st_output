...
Run finished at Mon Oct 14 12:30:28 2019
Global runtime       = 1308ms / 1.308s
Number of processors = 1
# Rank: 0

                                                                        Event |      Count |  Total[ms] |    Max[ms] |    Min[ms] |    Avg[ms] | Time Ratio |
-------------------------------------------------------------------------------------------------------------------------------------------------------------
                                                                      _GLOBAL |          1 |       1308 |       1308 |       1308 |       1308 |          1 |
                                                                      advance |         30 |       1158 |         40 |          0 |         38 |      0.885 |
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |         29 |          0 |          0 |          0 |          0 |          0 |
                                                                   ...
                                                                   initialize |          1 |         67 |         67 |         67 |         67 |     0.0512 |
                                        initialize/m2n.acceptMasterConnection |          1 |         26 |         26 |         26 |         26 |     0.0199 |
     ...
     initialize/map.np.computeMapping.FromMeshOneToMeshTwo.getIndexOnVertices |          1 |          0 |          0 |          0 |          0 |          0 |
                               ...
                               initialize/partition.receiveGlobalMesh.MeshOne |          1 |         39 |         39 |         39 |         39 |     0.0298 |
                                                               initializeData |          1 |          0 |          0 |          0 |          0 |          0 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |          0 |          0 |          0 |          0 |          0 |
                                        ...
                                        initialize/m2n.acceptMasterConnection |         26 |          0 |         26 |          0 |          1 |
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> 40e8aa482efb
Removing intermediate container a4be9a7e2919
Step 29/29 : RUN mkdir /Output
 ---> Running in 04fafb8bbef5
 ---> e0394b018e83
Removing intermediate container 04fafb8bbef5
Successfully built e0394b018e83
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
1bb6088edc233f557a22900766b32136730a4f58d4d8ef1ad84d7b95ea6fa8dc
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:00a78fa4:start=1571056079619252231,finish=1571056229028160628,duration=149408908397,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:00d5a6e9[0K$ python push.py -s -t bindings
Cloning into '[secure]_st_output'...
 ```
[Full job log](https://api.travis-ci.org/v3/job/597589869/log.txt)