...
Job: [1177.17](https://travis-ci.org/precice/systemtests/jobs/618293082) 
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
                        ...
                        initialize/map.np.computeMapping.FromMeshOneToMeshTwo |          1 |          3 |          3 |          3 |          3 |    0.00234 |
     ...
     initialize/map.np.computeMapping.FromMeshOneToMeshTwo.getIndexOnVertices |          1 |          0 |          0 |          0 |          0 |          0 |
                               ...
                               initialize/partition.receiveGlobalMesh.MeshOne |          1 |         30 |         30 |         30 |         30 |     0.0234 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
     ...
     initialize/map.np.computeMapping.FromMeshOneToMeshTwo.getIndexOnVertices |          0 |          0 |          0 |          0 |          0 |
                               ...
                               initialize/partition.receiveGlobalMesh.MeshOne |         30 |          0 |         30 |          0 |          1 |
                                                               initializeData |          0 |          0 |          0 |          0 |          0 |
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> cab8abe36f76
Removing intermediate container ffae3e533444
Step 25/25 : RUN mkdir /Output
 ---> Running in a121fff34100
 ---> c5b7841079c0
Removing intermediate container a121fff34100
Successfully built c5b7841079c0
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
4ffe42ca41af597113cf3780a76200d9d79826e5932caff0d3918b63f06f174d
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:0348a430:start=1574966324893771688,finish=1574966456739501681,duration=131845729993,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:20b6ce0a[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.14
Parsing documentation for dpl-1.10.14
Installing ri documentation for dpl-1.10.14
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:20b6ce0a:start=1574966461604353621,finish=1574966463507314940,duration=1902961319,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:1fd242cb[0Ktravis_fold:start:dpl.1[33mInstalling deploy dependencies[0m
...
```
[
Full job log](https://api.travis-ci.org/v3/job/618293082/log.txt)