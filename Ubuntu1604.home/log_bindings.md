...
Job: [1264.18](https://travis-ci.org/precice/systemtests/jobs/621025170) 
...
----------------------------------------------------------------------------------------------------------------------------
                                     ...
                                     advance |         30 |       1236 |         77 |         39 |         41 |      0.965 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> 4ac6d937a894
Removing intermediate container 2f94390a4fde
Step 27/29 : USER root
 ---> Running in 71d6de05d976
 ---> 6e2743406459
Removing intermediate container 71d6de05d976
Step 28/29 : RUN mkdir /Output
 ---> Running in afd05324c12e
 ---> 30994313cc63
Removing intermediate container afd05324c12e
Step 29/29 : USER [secure]
 ---> Running in 19966323d7a6
 ---> ee313295adc8
Removing intermediate container 19966323d7a6
Successfully built ee313295adc8
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
e3c9e790c6ba3ff8a79a1acb4969bf4ec39daa4e9c235ca837bb3d1b5caa0c40
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:10507500:start=1575540493689412609,finish=1575540614855974641,duration=121166562032,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:0532cafa[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
...
```
[
Full job log](https://api.travis-ci.org/v3/job/621025170/log.txt)