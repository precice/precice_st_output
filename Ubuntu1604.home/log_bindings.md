...
Job: [1047.21](https://travis-ci.org/precice/systemtests/jobs/604758650) 
...
```
                                                                    configure |          1 |          1 |          1 |          1 |          1 |   0.000776 |
                                                                     finalize |          1 |         79 |         79 |         79 |         79 |     0.0613 |
                                                                   initialize |          1 |         48 |         48 |         48 |         48 |     0.0373 |
                                        initialize/m2n.acceptMasterConnection |          1 |         15 |         15 |         15 |         15 |     0.0116 |
     ...
     initialize/map.np.computeMapping.FromMeshOneToMeshTwo.getIndexOnVertices |          1 |          0 |          0 |          0 |          0 |          0 |
                               ...
                               initialize/partition.receiveGlobalMesh.MeshOne |          1 |         31 |         31 |         31 |         31 |     0.0241 |
...
Run finished at Wed Oct 30 02:42:33 2019
...
----------------------------------------------------------------------------------------------------------------------------
                                     ...
                                     advance |         30 |       1235 |         76 |         39 |         41 |      0.962 |
                                   configure |          1 |          0 |          0 |          0 |          0 |          0 |
                                    finalize |          1 |         43 |         43 |         43 |         43 |     0.0335 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
     ...
     initialize/map.np.computeMapping.FromMeshOneToMeshTwo.getIndexOnVertices |          0 |          0 |          0 |          0 |          0 |
                               ...
                               initialize/partition.receiveGlobalMesh.MeshOne |         31 |          0 |         31 |          0 |          1 |
                                                               initializeData |          0 |          0 |          0 |          0 |          0 |
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> 3c7bf986934b
Removing intermediate container 66654f83f95a
Step 29/29 : RUN mkdir /Output
 ---> Running in 49f6e53c66f5
 ---> e8d1a661828e
Removing intermediate container 49f6e53c66f5
Successfully built e8d1a661828e
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
38bdad9984ce07a3575d6fa72be71cdb9795a83d5b36afede0ca96d5c35c58ff
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:01603e57:start=1572403211392559391,finish=1572403354664079455,duration=143271520064,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:0171e3a6[0K$ python push.py -s -t bindings
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/604758650/log.txt)