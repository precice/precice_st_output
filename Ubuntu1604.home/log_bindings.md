...
Job: [1082.18](https://travis-ci.org/precice/systemtests/jobs/610801829) 
...
preCICE:[0m it 1 of 3 | dt# 11 of 10 | t 10 | dt 1 | max dt 1 | ongoing no | dt complete yes | 
 DUMMY: Advancing in time
Run finished at Tue Nov 12 11:56:34 2019
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |         29 |          0 |          0 |          0 |          0 |          0 |
                                                                    configure |          1 |          0 |          0 |          0 |          0 |          0 |
                                                                     finalize |          1 |         79 |         79 |         79 |         79 |     0.0604 |
                                                                   initialize |          1 |         67 |         67 |         67 |         67 |     0.0513 |
                                        initialize/m2n.acceptMasterConnection |          1 |         30 |         30 |         30 |         30 |      0.023 |
     ...
     initialize/map.np.computeMapping.FromMeshOneToMeshTwo.getIndexOnVertices |          1 |          0 |          0 |          0 |          0 |          0 |
                               ...
                               initialize/partition.receiveGlobalMesh.MeshOne |          1 |         35 |         35 |         35 |         35 |     0.0268 |
 ...
 initializeData/map.nn.computeMapping.FromMeshTwoToMeshOne.getIndexOnVertices |          1 |          0 |          0 |          0 |          0 |          0 |
                           ...
                           initializeData/map.np.mapData.FromMeshOneToMeshTwo |          1 |          0 |          0 |          0 |          0 |          0 |
                                                            ...
                                                            solver.initialize |          1 |          1 |          1 |          1 |          1 |   0.000765 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |          0 |          0 |          0 |          0 |          0 |
                                                                   ...
                                                                   initialize |         67 |          0 |         67 |          0 |          1 |
                                        initialize/m2n.acceptMasterConnection |         30 |          0 |         30 |          0 |          1 |
 ...
 ---> 8af68c061242
Removing intermediate container 0c7de41d13ec
Step 29/29 : RUN mkdir /Output
 ---> Running in 4a2fbb78248b
 ---> 07a9d46fbbfc
Removing intermediate container 4a2fbb78248b
Successfully built 07a9d46fbbfc
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
aeb593416f3d696fe71fbdeac4214e8b2218384ce93a36a48947af4c223e750a
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:0338807e:start=1573559647677359546,finish=1573559795494677004,duration=147817317458,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:03233312[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.13
Parsing documentation for dpl-1.10.13
Installing ri documentation for dpl-1.10.13
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:03233312:start=1573559800336035843,finish=1573559802102479033,duration=1766443190,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:041183e2[0Ktravis_fold:start:dpl.1[33mInstalling deploy dependencies[0m
...
```
[
Full job log](https://api.travis-ci.org/v3/job/610801829/log.txt)