...
Job: [1054.21](https://travis-ci.org/precice/systemtests/jobs/606282159) 
...
preCICE:[0m it 1 of 3 | dt# 2 of 10 | t 1 | dt 1 | max dt 1 | ongoing yes | dt complete yes | write-iteration-checkpoint | 
 DUMMY: Advaation-checkpoint | 
 DUMMY: Advancing in time
 DUMMY: Writing iteration checkpoint
preCICE:[0m min iteration convergence measure: #it = 1 of 5, conv = false
preCICE:[0m it 2 of 3 | dt# 5 of 10 | t 4 | dt 1 | max dt 1 | ongoing yes | dt complete no | read-iteration-checkpoint | 
 DUMMY: Reading iteration checkpoint
preCICE:[0m it 2 of 3 | dt# 5 of 10 | t 4 | dt 1 | max dt 1 | ongoing yes | dt complete no | read-iteration-checkpoint | 
 DUMMY: Reading iteration checkpoint
preCICE:[0m min iteration convergence measure: #it = 2 of 5, conv = false
preCICE:[0m it 3 of 3 | dt# 5 of 10 | t 4 | dt 1 | max dt 1 | ongoing yes | dt complete no | read-iteration-checkpoint | 
 DUMMY: Reading iteration checkpoint
preCICE:[0m it 3 of 3 | dt# 5 of 10 | t 4 | dt 1 | max dt 1 | ongoing yes | dt complete no | read-iteration-checkpoint | 
 DUMMY: Reading iteration checkpoint
...
preCICE:[0m it 2 of 3 | dt# 7 of 10 | t 6 | dt 1 | max dt 1 | ongoing yes | dt complete no | read-iteration-checkpoint | 
 DUMMY: Reading iteration checkpoint
preCICE:[0m min iteration convergence measure: #it = 2 of 5, conv = false
preCICE:[0m it 3 of 3 | dt# 7 of 10 | t 6 | dt 1 | max dt 1 | ongoing yes | dt complete no | re   78 |         39 |         41 |      0.948 |
                                   configure |          1 |          0 |          0 |          0 |          0 |          0 |
                                    finalize |          1 |         39 |         39 |         39 |         39 |     0.0299 |
                                  initialize |          1 |         24 |         24 |         24 |         24 |     0.0184 |
      initialize/m2n.requestMasterConnection |          1 |         21 |         21 |         21 |         21 |     0.0161 |
 ...
 initialize/partition.sendGlobalMesh.MeshOne |          1 |          0 |          0 |          0 |          0 |          0 |
                              ...
                              solver.advance |         30 |          1 |          0 |          0 |          0 |   0.000766 |
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
                        ...
                        initialize/map.np.computeMapping.FromMeshOneToMeshTwo |          1 |          0 |          0 |                                          initializeData |          0 |          0 |          0 |          0 |          0 |
 ...
 ---> dd762f15607f
Removing intermediate container f9f984211fe0
Step 29/29 : RUN mkdir /Output
 ---> Running in 9708631b5534
 ---> 35ea3504e37d
Removing intermediate container 9708631b5534
Successfully built 35ea3504e37d
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
636e5baa125f96ec314bcf397452704777dceb26fedd0d327f6daa501393351a
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:29f33180:start=1572662628041528059,finish=1572662777735516402,duration=149693988343,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:after_success[0Ktravis_time:start:05ffdf05[0K$ python push.py -s -t bindings
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/606282159/log.txt)