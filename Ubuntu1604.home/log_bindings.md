...
Job: [1459.22](https://travis-ci.org/precice/systemtests/jobs/637887953) 
...
```
                           ...
                           initializeData/map.np.mapData.FromMeshOneToMeshTwo |          1 |          0 |          0 |          0 |          0 |          0 |
                                                               solver.advance |         30 |          1 |          0 |          0 |          0 |    0.00613 |
...
------------------------------------------------------------------------------------------------------------------------------------------------
                                  ...
                                  advance/map.np.mapData.FromMeshOneToMeshTwo |          0 |          0 |          0 |          0 |          0 |
                                                                    configure |          0 |          0 |          0 |          0 |          0 |
                                                                     finalize |          1 |          0 |          1 |          0 |          1 |
                                                                   initialize |        102 |          0 |        102 |          0 |          1 |
                                        initialize/m2n.acceptMasterConnection |         17 |          0 |         17 |          0 |          1 |
                                        initialize/m2n.acceptSlavesConnection |         41 |          0 |         41 |          0 |          1 |
...
eData/map.np.mapData.FromMeshOneToMeshTwo |          0 |          0 |          0 |          0 |          0 |
 ...
 DUMMY: Closing Fortran solver dummy...
 ---> 3c6e12103e01
Removing intermediate container 7bd3ddad136c
Step 27/29 : USER root
 ---> Running in bdb87e4ab4c8
 ---> dce629f50721
Removing intermediate container bdb87e4ab4c8
Step 28/29 : RUN mkdir /Output
 ---> Running in cbb67fe0a012
 ---> 43410cee0c08
Removing intermediate container cbb67fe0a012
Step 29/29 : USER [secure]
 ---> Running in 4fbcce7d12c2
 ---> 77363f4d2b87
Removing intermediate container 4fbcce7d12c2
Successfully built 77363f4d2b87
Successfully tagged st_bindings-ubuntu1604.home-develop:latest
93ed3dce1f5a3f2c065bc46568f2f2fbb2edac6f76aa59306e47975682f87bb3
EXECUTING: docker build --network=host --file Dockerfile --tag st_bindings-ubuntu1604.home-develop --build-arg from=[secure]/[secure]-ubuntu1604.home-develop:latest .
EXECUTING: docker run -it -d --name st_bindings-ubuntu1604.home-develop st_bindings-ubuntu1604.home-develop
EXECUTING: docker cp st_bindings-ubuntu1604.home-develop:Output . 
travis_time:end:000f7824:start=1579174840314336109,finish=1579174943797293921,duration=103482957812,event=script[0K[32;1mThe command "python system_testing.py -s bindings" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:27db570f[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
Successfully installed dpl-1.10.14
Parsing documentation for dpl-1.10.14
Installing ri documentation for dpl-1.10.14
Done installing documentation for dpl after 0 seconds
1 gem installed
travis_time:end:27db570f:start=1579174947732831351,finish=1579174949017409911,duration=1284578560,event=after_success[0Ktravis_fold:end:dpl_0[0Ktravis_time:start:08081a1a[0Ktravis_fold:start:dpl.1[33mInstalling deploy dependencies[0m
...
```
[
Full job log](https://api.travis-ci.org/v3/job/637887953/log.txt)