...
Job: [1521.25](https://travis-ci.org/precice/systemtests/jobs/642317457) 
...
```
travis_fold:start:git.checkout[0Ktravis_time:start:054a3a3f[0K$ git clone --depth=50 --branch=develop https://github.com/[secure]/systemtests.git [secure]/systemtests
Cloning into '[secure]/systemtests'...
travis_time:end:054a3a3f:start=1580125432830883505,finish=1580125438043128169,duration=5212244664,event=checkout[0K$ cd [secure]/systemtests
$ git checkout -qf feb7379d4291423a8ea6ec40728f855e8268130b
travis_fold:end:git.checkout[0K
travis_time:end:054a3a3f:start=1580125432830883505,finish=1580125438085558534,duration=5254675029,event=checkout[0Ktravis_time:start:2e15d5c8[0K
...
travis_time:end:2e15d5c8:start=1580125438090234263,finish=1580125438099662554,duration=9428291,event=env[0Ktravis_time:start:06d3b8dc[0K$ source ~/virtualenv/python3.5/bin/activate
travis_time:end:06d3b8dc:start=1580125438103724948,finish=1580125438109291436,duration=5566488,event=[0K$ python --version
Python 3.5.6
$ pip --version
pip 18.0 from /home/travis/virtualenv/python3.5.6/lib/python3.5/site-packages/pip (python 3.5)
Could not locate requirements.txt. Override the install: key in your .travis.yml to install dependencies.
travis_time:start:13e494a4[0K$ python system_testing.py -s of-of_np
networks:
  [secure]comm: {}
services:
...
travis_time:end:13e494a4:start=1580125438386978223,finish=1580125563728699571,duration=125341721348,event=script[0K[32;1mThe command "python system_testing.py -s of-of_np" exited with 0.[0m

travis_fold:start:dpl_0[0Ktravis_time:start:086bc1dc[0K$ rvm $(travis_internal_ruby) --fuzzy do ruby -S gem install dpl
...
```
[
Full job log](https://api.travis-ci.org/v3/job/642317457/log.txt)