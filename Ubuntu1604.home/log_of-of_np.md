...
```
travis_time:start:00e34374[0K$ git fetch origin +refs/pull/150/merge:
From https://github.com/[secure]/systemtests
 * branch            refs/pull/150/merge -> FETCH_HEAD
travis_time:end:00e34374:start=1578780761235781105,finish=1578780761669299844,duration=433518739,event=checkout[0K$ git checkout -qf FETCH_HEAD
travis_fold:end:git.checkout[0K
travis_time:end:00e34374:start=1578780761235781105,finish=1578780761854641056,duration=618859951,event=checkout[0Ktravis_time:start:38c9c13c[0K
...
travis_time:end:38c9c13c:start=1578780761859574416,finish=1578780761870291356,duration=10716940,event=env[0Ktravis_time:start:1d61828c[0K$ source ~/virtualenv/python3.5/bin/activate
travis_time:end:1d61828c:start=1578780761875374267,finish=1578780761881254095,duration=5879828,event=[0K$ python --version
Python 3.5.6
$ pip --version
pip 18.0 from /home/travis/virtualenv/python3.5.6/lib/python3.5/site-packages/pip (python 3.5)
Could not locate requirements.txt. Override the install: key in your .travis.yml to install dependencies.
travis_time:start:001bc720[0K$ python system_testing.py -s of-of_np
networks:
  [secure]comm: {}
services:
...
Creating openfoam-adapter-fluid
Creating tutorial-data
[1A[2KCreating openfoam-adapter-solid ... [32mdone[0m[1B[1A[2KCreating tutorial-data ... [32mdone[0m[1B[1A[2KCreating openfoam-adapter-fluid ... [32mdone[0m[1BAttaching to openfoam-adapter-solid, tutorial-data, openfoam-adapter-fluid
...
[0m[32mopenfoam-adapter-fluid    |[0m sed: can't read [secure]-config.xml: No such file or directory
[33mtutorial-data exited with code 0
[0m[32mopenfoam-adapter-fluid exited with code 2
...
travis_time:end:001bc720:start=1578780762181822907,finish=1578780827274071078,duration=65092248171,event=script[0K[31;1mThe command "python system_testing.py -s of-of_np" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:0c5287e8[0K$ python push.py -t of-of_np
