...
Job: [1467.20](https://travis-ci.org/precice/systemtests/jobs/638371855) 
...
```
[0m[91m-                     25% |********                        | 6625k  0:00:43 ETA
[0m[91m-                     28% |********                        | 7187k  0:00:41 ETA
[0m[91m-                     30% |*********                       | 7697k  0:00:39 ETA
[0m[91m-                     32% |**********                      | 8273k  0:00:37 ETA
[0m[91m-                     34% |***********                     | 8825k  0:00:36 ETA
[0m[91m-                     36% |***********                     | 9383k  0:00:34 ETA
[0m[91m-                     38% |************                    | 9943k  0:00:33 ETA
[0m[91m-                     41% |*************                   | 10.2M  0:00:31 ETA
[0m[91m-                     43% |*************                   | 10.7M  0:00:30 ETA
[0m[91m-                     45% |**************                  | 11.3M  0:00:28 ETA
[0m[91m-                     47% |***************                 | 11.8M  0:00:27 ETA
[0m[91m-                     49% |***************                 | 12.4M  0:00:26 ETA
[0m[91m-                     51% |****************                | 12.9M  0:00:25 ETA
[0m[91m-                     54% |*****************               | 13.5M  0:00:23 ETA
[0m[91m-                     56% [0m[91m|*****************               | 14.0M  0:00:22 ETA
...
Completed.
 ---> 66beee3cde17
Removing intermediate container 3aa4564264f2
Step 11/14 : WORKDIR /
 ---> 51af32880668
Removing intermediate container 4c5b51118226
Step 12/14 : RUN sed -i 's|exchange-directory\="."|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g'     configs/[secure]-config.xml && cp $tutorial_path/config.yml  configs/config.yml
 ---> Running in 4fbc72b47700
 ---> 142f685ddffc
Removing intermediate container 4fbc72b47700
Step 13/14 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in 0d5b9804ea3f
 ---> e87a2b3153d3
Removing intermediate container 0d5b9804ea3f
Step 14/14 : USER [secure]
 ---> Running in eca7dda3a44b
 ---> 8809aa8431e9
Removing intermediate container eca7dda3a44b
Successfully built 8809aa8431e9
...
travis_time:end:1bb5d380:start=1579260975692867717,finish=1579261186014568140,duration=210321700423,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:074bcbf9[0K$ python push.py -t of-ccx
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/638371855/log.txt)