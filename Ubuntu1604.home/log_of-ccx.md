...
Job: [1387.20](https://travis-ci.org/precice/systemtests/jobs/632233838) 
...
```
[0m[91m-                     28% |*********                       | 7401k  0:00:34 ETA
[0m[91m-                     31% |*********                       | 7969k  0:00:33 ETA
[0m[91m-                     33% |**********                      | 8509k  0:00:32 ETA
[0m[91m-                     35% |***********                     | 9035k  0:00:31 ETA
[0m[91m-                     37% |***********                     | 9597k  0:00:30 ETA
...
[0m[91m-                    [0m[91m 99% |******************************* | 24.7M  0:00:00 ETA
...
Completed.
 ---> a22e787391ab
Removing intermediate container df6273c777f5
Step 11/14 : WORKDIR /
 ---> 110302d1e8c2
Removing intermediate container 306a9f4d8dc4
Step 12/14 : RUN sed -i 's|exchange-directory\="."|exchange-directory="/home/[secure]/Data/Exchange/" network="eth0"|g'     configs/[secure]-config.xml && cp $tutorial_path/config.yml  configs/config.yml
 ---> Running in 277c824dc6c6
 ---> 894fc962e6f4
Removing intermediate container 277c824dc6c6
Step 13/14 : RUN addgroup -g 1000 [secure] && adduser -u 1000 -G [secure] -D [secure] && chown -R [secure]:[secure] tutorials configs
 ---> Running in e7ff6b6ae22e
 ---> 3a0e4ead7be8
Removing intermediate container e7ff6b6ae22e
Step 14/14 : USER [secure]
 ---> Running in afd79bc2e86d
 ---> 52cfc8790c11
Removing intermediate container afd79bc2e86d
Successfully built 52cfc8790c11
...
Digest: sha256:42aba06ce40cec9bc6acf56fc9092ed292c528ba0090693cd385b5b40d268b01
...
travis_time:end:1a7e69ca:start=1578050929307998084,finish=1578051137177618449,duration=207869620365,event=script[0K[31;1mThe command "python system_testing.py -s of-ccx" exited with 1.[0m

travis_fold:start:after_failure[0Ktravis_time:start:04aebc6c[0K$ python push.py -t of-ccx
Cloning into '[secure]_st_output'...

```
[
Full job log](https://api.travis-ci.org/v3/job/632233838/log.txt)